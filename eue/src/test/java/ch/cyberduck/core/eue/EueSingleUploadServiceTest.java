...
public class EueSingleUploadServiceTest extends AbstractEueSessionTest {
    ...
    public void testUploadSimpleFile() throws Exception {
        ...
        final EueSingleUploadService EUESingleUploadService = new EueSingleUploadService(session, fileid, new EueWriteFeature(session, fileid));
        ...
        final Local local = new Local(System.getProperty("java.io.tmpdir"), name);
        {
            ...
            EUESingleUploadService.upload(file, local, new BandwidthThrottle(BandwidthThrottle.UNLIMITED), count, status, new DisabledConnectionCallback());
