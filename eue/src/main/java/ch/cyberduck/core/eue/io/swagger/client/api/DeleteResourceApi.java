...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-10-25T16:12:42.747787400+02:00[Europe/Berlin]")public class DeleteResourceApi {
  private ApiClient apiClient;

  public DeleteResourceApi() {
    this(Configuration.getDefaultApiClient());
  }

  public DeleteResourceApi(ApiClient apiClient) {
   ...
   */
  public void resourceResourceIdDelete(String resourceId, String cookie, String ifMatch) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'resourceId' is set
    if (resourceId == null) {
      throw new ApiException(400, "Missing the required parameter 'resourceId' when calling resourceResourceIdDelete");
    }
