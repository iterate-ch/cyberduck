...
public enum RegistrationValidationType {
  ...
  RegistrationValidationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RegistrationValidationType fromValue(String input) {
    for (RegistrationValidationType b : RegistrationValidationType.values()) {
