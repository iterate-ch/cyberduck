...
/**
 * Parameters of a job, depends on the job type.
 */
@Schema(description = "Parameters of a job, depends on the job type.")


public class IdgardJobParametersDto {
  ...
  public String toString() {
    ...
    sb.append("class IdgardJobParametersDto {\n");
