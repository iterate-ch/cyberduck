...
/**
 * Progress of a job, depends on the job type. Guaranteed to be present for all job states except &#x27;CREATED&#x27;.
 */
@Schema(description = "Progress of a job, depends on the job type. Guaranteed to be present for all job states except 'CREATED'.")


public class IdgardJobProgressDto {
  ...
  public String toString() {
    ...
    sb.append("class IdgardJobProgressDto {\n");
