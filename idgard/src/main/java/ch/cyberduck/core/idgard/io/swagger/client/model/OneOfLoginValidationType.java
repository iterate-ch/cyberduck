...
@JsonTypeInfo(
  ...
  property = "")
@JsonSubTypes({
  @JsonSubTypes.Type(value = LoginValidationTypeOrNone.class, name = "LoginValidationTypeOrNone")
})
public interface OneOfLoginValidationType {
