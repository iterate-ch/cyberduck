...
public class QloudstatAnalyticsProviderTest extends AbstractTestCase {
    ...
    public void testGetSetup() throws Exception {
        ...
        Assert.assertEquals("https://qloudstat.com/configuration/add?setup=cHJvdmlkZXI9czMuYW1hem9uYXdzLmNvbSxlbmRwb2ludD1jeWJlcmR1Y2stdGVzdGluZyxrZXk9cWxvdWRzdGF0LHNlY3JldD1zZWNyZXQ%3D", q.getSetup(Protocol.S3_SSL, "cyberduck-testing", new Credentials("qloudstat", "secret") {
            @Override
