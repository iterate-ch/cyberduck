...
public class TransferCollectionTest extends AbstractTestCase {
    ...
    public void testEmpty() throws Exception {
        TransferCollection c = new TransferCollection(new Local("test/ch/cyberduck/core/transfer/TransferCollectionEmpty.plist")) {
            @Override
            public void trash() {
                //
            }
    ...
    public void testLoadCopyDeprecated() throws Exception {
        TransferCollection c = new TransferCollection(new Local("test/ch/cyberduck/core/transfer/TransferCollectionCopyFormatDeprecated.plist")) {
            @Override
            public void trash() {
                //
            }
    ...
    public void testLoadCopyInvalidCopyTransfer() throws Exception {
        TransferCollection c = new TransferCollection(new Local("test/ch/cyberduck/core/transfer/TransferCollectionCopyFormatInvalid.plist")) {
            @Override
            public void trash() {
                //
            }
    ...
    public void testLoadCopyWithDestination() throws Exception {
        TransferCollection c = new TransferCollection(new Local("test/ch/cyberduck/core/transfer/TransferCollectionCopyFormat.plist")) {
            @Override
            public void trash() {
                //
            }
