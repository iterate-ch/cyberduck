...
public class SFTPMoveFeatureTest extends AbstractTestCase {
    ...
    public void testMove() throws Exception {
        ...
        new SFTPDeleteFeature(session).delete(Collections.<Path>singletonList(target));
    }
    ...
    public void testMoveNotFound() throws Exception {
        ...
        session.login(new DisabledPasswordStore(), new DisabledLoginController());
        final Path test = new Path(session.home(), UUID.randomUUID().toString(), Path.FILE_TYPE);
        new SFTPMoveFeature(session).move(test, new Path(session.home(), UUID.randomUUID().toString(), Path.FILE_TYPE));
    }
}
