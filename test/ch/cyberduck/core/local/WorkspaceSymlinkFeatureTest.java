...
public class WorkspaceSymlinkFeatureTest extends AbstractTestCase {
    ...
    public void testSymlink() throws Exception {
        final Local target = new FinderLocal(Preferences.instance().getProperty("tmp.dir"),
                UUID.randomUUID().toString());
        new DefaultLocalTouchFeature().touch(target);
        final FinderLocal symlink = new FinderLocal(Preferences.instance().getProperty("tmp.dir"),
                UUID.randomUUID().toString());
