 ...
 * @version $Id$
 */
public class TerminalTransferFactoryTest extends AbstractTestCase {
    ...
    public void testFilter() throws Exception {
        ...
        assertFalse(transfer.list(null, new Path("/remote", EnumSet.of(Path.Type.directory)), new NullLocal("/tmp"), new DisabledListProgressListener()).isEmpty());
        cache.clear();
        ...
        assertTrue(transfer.list(null, new Path("/remote", EnumSet.of(Path.Type.directory)), new NullLocal("/tmp"), new DisabledListProgressListener()).isEmpty());
    }
}