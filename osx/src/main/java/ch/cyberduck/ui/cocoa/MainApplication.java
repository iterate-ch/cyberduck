...
public final class MainApplication extends ProxyController implements NSApplication.Delegate {
    ...
    public final MainController controller = new MainController();
    ...
    public static void main(String... arguments) {
        ...
        try {
            ...
            final MainApplication delegate = new MainApplication();
        ...
        if(f.exists()) {
            if("duck".equals(f.getExtension())) {
                ...
                try {
                    ...
                    controller.newDocument().mount(bookmark);
                    return true;
                }
                ...
                try {
                    ...
                    if(profile.isEnabled()) {
                        ...
                        controller.newDocument().addBookmark(host);
    ...
    public boolean applicationShouldHandleReopen_hasVisibleWindows(final NSApplication app, final boolean visibleWindowsFound) {
        ...
        if(MainController.getBrowsers().isEmpty() && !TransferControllerFactory.get().isVisible()) {
            controller.openDefaultBookmark(controller.newDocument());
        }
    ...
    public void applicationDidFinishLaunching(NSNotification notification) {
        ...
        if(preferences.getBoolean("browser.open.untitled")) {
            final BrowserController c = controller.newDocument();
            ...
            this.background(new AbstractBackgroundAction<Void>() {
                ...
                public void cleanup() {
                    for(Host host : sessions) {
                        ...
                        final BrowserController browser = controller.newDocument(false, host.getUuid());
                        browser.mount(host);
                    }
                    sessions.clear();
                }
        ...
        this.background(new AbstractBackgroundAction<Void>() {
            ...
            public void cleanup() {
                ...
                NSApplication.sharedApplication().setServicesProvider(MainApplication.this.id());
            }
    ...
    public void handleGetURLEvent_withReplyEvent(NSAppleEventDescriptor event, NSAppleEventDescriptor reply) {
        ...
        if("x-cyberduck-action:update".equals(url)) {
            ...
            if(Path.Type.file == detector.detect(h.getDefaultPath())) {
                ...
                final BrowserController browser = controller.newDocument(false);
                browser.mount(h);
            }
        }
    }
