...
public final class AlertUploadShareWorker<Options> extends UploadShareWorker<Options> {
    ...
    public AlertUploadShareWorker(final ProxyController controller, final Path file, final Options options, final PasswordCallback password, final Share.ShareeCallback sharee) {
