...
import ch.cyberduck.core.storegate.io.swagger.client.model.Server;
...
public class PublicApi {
   ...
   */
  public Server publicGet() throws ApiException {
    return publicGetWithHttpInfo().getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Server> publicGetWithHttpInfo() throws ApiException {
