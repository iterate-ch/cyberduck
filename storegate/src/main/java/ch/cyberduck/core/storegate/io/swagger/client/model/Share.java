...
public class Share {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(itemId, name, path, type, id, created, accessed, lastAccessed, ownerId, password, sentToEmails, accessLimit, accessUntil, allowUpload, uploadNotificationEmails, uploadHideContents, mediaAllowDownload, allowComments, bankIDContacts, authMethod, allowOfficeOnline, allowOfficeOnlineEdit);
  }
