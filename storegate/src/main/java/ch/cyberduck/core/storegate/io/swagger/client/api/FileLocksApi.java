...
public class FileLocksApi {
   ...
   */
  public void fileLocksDeleteLock(String id) throws ApiException {

    fileLocksDeleteLockWithHttpInfo(id);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> fileLocksDeleteLockWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling fileLocksDeleteLock");
    }
    
    // create path and map variables
    String localVarPath = "/v4/filelocks/fileid/{id}"
