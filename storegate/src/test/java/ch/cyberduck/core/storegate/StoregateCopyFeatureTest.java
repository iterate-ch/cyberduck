...
public class StoregateCopyFeatureTest extends AbstractStoregateTest {
    ...
    public void testCopyFileServerSide() throws Exception {
        ...
        assertNull(new StoregateCopyFeature(session, nodeid).copy(test, copy, new TransferStatus(), new DisabledConnectionCallback()).attributes().getFileId());
    ...
    public void testCopyFileWithRename() throws Exception {
        ...
        assertNull(new StoregateCopyFeature(session, fileid).copy(test, copy, new TransferStatus(), new DisabledConnectionCallback()).attributes().getFileId());
        assertTrue(new DefaultFindFeature(session).find(test));
        assertTrue(new DefaultFindFeature(session).find(copy));
    ...
    public void testCopyServerSideToExistingFile() throws Exception {
        ...
        assertTrue(feature.isSupported(test, copy));
        assertNull(new StoregateCopyFeature(session, fileid).copy(test, copy, new TransferStatus().exists(true), new DisabledConnectionCallback()).attributes().getFileId());
    ...
    public void testCopyWithRenameToExistingFile() throws Exception {
        ...
        assertNull(new StoregateCopyFeature(session, fileid).copy(test, test2, new TransferStatus().exists(true), new DisabledConnectionCallback()).attributes().getFileId());
        final Find find = new DefaultFindFeature(session);
    ...
    public void testCopyDirectoryServerSide() throws Exception {
        ...
        assertNull(copy.attributes().getFileId());
