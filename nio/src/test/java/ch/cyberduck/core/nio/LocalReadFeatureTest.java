...
public class LocalReadFeatureTest {
    ...
    public void testReadNotFound() throws Exception {
        ...
        new LocalReadFeature(session).read(new Path(workdir, "nosuchname", EnumSet.of(Path.Type.file)), status, ConnectionCallback.noop);
    }
    ...
    public void testRead() throws Exception {
        ...
        final byte[] content = RandomUtils.nextBytes(length);
        {
            ...
            final OutputStream out = new LocalWriteFeature(session).write(test, status, ConnectionCallback.noop);
            assertNotNull(out);
        ...
        }
        {
            ...
            final InputStream in = new LocalReadFeature(session).read(test, status, ConnectionCallback.noop);
            assertNotNull(in);
