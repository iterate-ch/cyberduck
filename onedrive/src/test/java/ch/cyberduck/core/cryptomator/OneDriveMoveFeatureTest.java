...
public class OneDriveMoveFeatureTest extends AbstractOneDriveTest {
    ...
    public void testMove() throws Exception {
        ...
        new CryptoTouchFeature<Void>(session, new DefaultTouchFeature<Void>(new DefaultUploadFeature<>(new OneDriveWriteFeature(session))), new OneDriveWriteFeature(session), cryptomator).touch(file, new TransferStatus());
