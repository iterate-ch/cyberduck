...
public class SingleTransferWorkerTest extends AbstractOneDriveTest {
    ...
    public void testUpload() throws Exception {
        ...
        assertTrue(new CryptoFindFeature(session, new GraphFindFeature(session), cryptomator).find(dir1, new DisabledListProgressListener()));
        ...
        new CryptoDeleteFeature(session, new GraphDeleteFeature(session), cryptomator).delete(Arrays.asList(file1, file2, dir1, vault), new DisabledLoginCallback(), new Delete.DisabledCallback());
        localFile1.delete();
        localFile2.delete();
