...
public class GraphMoveFeatureTest extends AbstractOneDriveTest {
    ...
    public void testMove() throws Exception {
        ...
        assertFalse(new CryptoFindFeature(session, new GraphFindFeature(session), cryptomator).find(new Path(folder, filename, EnumSet.of(Path.Type.file)), new DisabledListProgressListener()));
        ...
        assertEquals(fileRenamed.attributes().getModificationDate(), new CryptoAttributesFeature(session, new GraphAttributesFinderFeature(session), cryptomator).find(fileRenamed, new DisabledListProgressListener()).getModificationDate());
        // rename folder
        ...
        assertFalse(new CryptoFindFeature(session, new GraphFindFeature(session), cryptomator).find(folder, new DisabledListProgressListener()));
        ...
        assertTrue(new CryptoFindFeature(session, new GraphFindFeature(session), cryptomator).find(fileRenamedInRenamedFolder, new DisabledListProgressListener()));
        new CryptoDeleteFeature(session, new GraphDeleteFeature(session), cryptomator).delete(Arrays.asList(
