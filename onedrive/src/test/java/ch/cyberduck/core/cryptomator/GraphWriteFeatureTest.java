...
public class GraphWriteFeatureTest extends AbstractOneDriveTest {
    ...
    public void testWrite() throws Exception {
        ...
        final PathAttributes attributes = new CryptoListService(session, new GraphItemListService(session), new GraphFindFeature(session), cryptomator).list(test.getParent(), new DisabledListProgressListener()).find(new SimplePathPredicate(test)).attributes();
