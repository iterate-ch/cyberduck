...
public class OneDriveListServiceTest extends AbstractOneDriveTest {
    ...
    public void testListCryptomator() throws Exception {
        ...
        assertEquals(new SimplePathPredicate(test), new SimplePathPredicate(new CryptoListService(session, new OneDriveListService(session), cryptomator).list(vault, new DisabledListProgressListener()).get(0)));
