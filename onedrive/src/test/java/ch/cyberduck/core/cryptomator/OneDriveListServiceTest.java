...
public class OneDriveListServiceTest extends AbstractOneDriveTest {
    ...
    public void testListCryptomator() throws Exception {
        ...
        assertTrue(new CryptoListService(session, new OneDriveListService(session, new GraphFileIdProvider(session)), cryptomator).list(vault, new DisabledListProgressListener()).isEmpty());
        ...
        assertEquals(new SimplePathPredicate(test), new SimplePathPredicate(new CryptoListService(session, new OneDriveListService(session, new GraphFileIdProvider(session)), cryptomator).list(vault, new DisabledListProgressListener()).get(0)));
