...
public class MoveWorkerTest extends AbstractOneDriveTest {
    ...
    public void testMoveFileIntoVault() throws Exception {
        ...
        new DefaultTouchFeature<Void>(new DefaultUploadFeature<>(new GraphWriteFeature(session, fileid)), new GraphAttributesFinderFeature(session, fileid)).touch(clearFile, new TransferStatus());
    ...
    public void testMoveDirectoryIntoVault() throws Exception {
        ...
        new DefaultTouchFeature<Void>(new DefaultUploadFeature<>(new GraphWriteFeature(session, fileid)),
            new GraphAttributesFinderFeature(session, fileid)).touch(clearFile, new TransferStatus());
