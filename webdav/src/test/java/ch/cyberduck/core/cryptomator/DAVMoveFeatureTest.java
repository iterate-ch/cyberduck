...
public class DAVMoveFeatureTest {
    ...
    public void testMove() throws Exception {
        ...
        assertFalse(new CryptoFindFeature(session, new DAVFindFeature(session), cryptomator).find(file, new DisabledListProgressListener()));
        ...
        assertEquals(fileRenamed.attributes(), new CryptoAttributesFeature(session, new DAVAttributesFinderFeature(session), cryptomator).find(fileRenamed, new DisabledListProgressListener()));
        // rename folder
        ...
        assertFalse(new CryptoFindFeature(session, new DAVFindFeature(session), cryptomator).find(folder, new DisabledListProgressListener()));
