...
public class DAVListServiceTest extends AbstractDAVTest {
    ...
    public void testListCryptomator() throws Exception {
        ...
        assertTrue(new CryptoListService(session, new DAVListService(session), new DAVFindFeature(session), cryptomator).list(vault, new DisabledListProgressListener()).isEmpty());
        ...
        assertEquals(test, new CryptoListService(session, new DAVListService(session), new DAVFindFeature(session), cryptomator).list(vault, new DisabledListProgressListener()).get(0));
