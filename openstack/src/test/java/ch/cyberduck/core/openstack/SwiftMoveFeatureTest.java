...
public class SwiftMoveFeatureTest extends AbstractSwiftTest {
    ...
    public void testSupport() {
        ...
        assertFalse(new SwiftMoveFeature(session).isSupported(c, c.getParent(), c.getName()));
        final Path cf = new Path("/c/f", EnumSet.of(Path.Type.directory));
        assertTrue(new SwiftMoveFeature(session).isSupported(cf, cf.getParent(), cf.getName()));
    }
