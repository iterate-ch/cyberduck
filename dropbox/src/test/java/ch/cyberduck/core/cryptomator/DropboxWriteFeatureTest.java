...
public class DropboxWriteFeatureTest extends AbstractDropboxTest {
    ...
    public void testWrite() throws Exception {
        ...
        final PathAttributes pathAttributes = new CryptoListService(session, new DropboxListService(session), new DropboxFindFeature(session), cryptomator).list(test.getParent(), new DisabledListProgressListener()).get(test).attributes();
