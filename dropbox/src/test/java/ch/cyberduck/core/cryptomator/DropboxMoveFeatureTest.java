...
public class DropboxMoveFeatureTest extends AbstractDropboxTest {
    ...
    public void testMove() throws Exception {
        ...
        assertFalse(new CryptoFindFeature(session, new DropboxFindFeature(session), cryptomator).find(file, new DisabledListProgressListener()));
        ...
        assertFalse(new CryptoFindFeature(session, new DropboxFindFeature(session), cryptomator).find(folder, new DisabledListProgressListener()));
        ...
        assertTrue(new CryptoFindFeature(session, new DropboxFindFeature(session), cryptomator).find(fileRenamedInRenamedFolder, new DisabledListProgressListener()));
