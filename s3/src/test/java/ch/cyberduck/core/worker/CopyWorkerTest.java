...
public class CopyWorkerTest extends AbstractS3Test {
    ...
    public void testCopyFileToDirectory() throws Exception {
        ...
        new S3TouchFeature(session).touch(new S3WriteFeature(session), sourceFile, new TransferStatus());
        ...
        new S3DirectoryFeature(session).mkdir(new S3WriteFeature(session), targetFolder, new TransferStatus());
    ...
    public void testCopyDirectory() throws Exception {
        ...
        final S3AccessControlListFeature acl = new S3AccessControlListFeature(session);
        new S3DirectoryFeature(session).mkdir(new S3WriteFeature(session), folder, new TransferStatus());
        new S3TouchFeature(session).touch(new S3WriteFeature(session), sourceFile, new TransferStatus());
