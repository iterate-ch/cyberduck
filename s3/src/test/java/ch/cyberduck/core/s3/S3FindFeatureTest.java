...
public class S3FindFeatureTest {
    ...
    public void testFindNotFound() throws Exception {
        ...
        assertFalse(f.find(test, new DisabledListProgressListener()));
    }
    ...
    public void testFindRoot() throws Exception {
        assertTrue(new S3FindFeature(new S3Session(new Host(new S3Protocol()))).find(new Path("/", EnumSet.of(Path.Type.directory)), new DisabledListProgressListener()));
    }
}
