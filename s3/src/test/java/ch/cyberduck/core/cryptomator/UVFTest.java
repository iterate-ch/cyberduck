...
//            .withLocalCompose(true)
    ...
    public void listMinio() throws BackgroundException, IOException {
        ...
        for(final String fi : files) {
            final Path file = new Path("/cyberduckbucket/" + fi, EnumSet.of(AbstractPath.Type.file));
        ...
        assertEquals("/cyberduckbucket/d/RK/HZLENL3PQIW6GZHE3KRRRGLFBHWHRU. Please contact your web hosting service provider for assistance.", backgroundException.getDetail());
    }
}
