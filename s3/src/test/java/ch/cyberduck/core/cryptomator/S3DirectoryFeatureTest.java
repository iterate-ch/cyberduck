...
public class S3DirectoryFeatureTest {
    ...
    public void testMakeDirectoryEncrypted() throws Exception {
        ...
        final PathAttributes attributes = new CryptoAttributesFeature(session, new S3AttributesFinderFeature(session), cryptomator).find(test, new DisabledListProgressListener());
