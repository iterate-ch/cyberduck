...
public class Body53 {
  ...
  public Body53 name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "Customer Support", description = "The name of the new group to be created. Must be unique within the enterprise.")
  ...
  public Body53 provenance(String provenance) {
  ...
  **/
  ...
  public Body53 externalSyncIdentifier(String externalSyncIdentifier) {
  ...
  **/
  ...
  public Body53 description(String description) {
  ...
  **/
  ...
  public Body53 invitabilityLevel(InvitabilityLevelEnum invitabilityLevel) {
  ...
  **/
  ...
  public Body53 memberViewabilityLevel(MemberViewabilityLevelEnum memberViewabilityLevel) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Body53 body53 = (Body53) o;
    return Objects.equals(this.name, body53.name) &&
        Objects.equals(this.provenance, body53.provenance) &&
        Objects.equals(this.externalSyncIdentifier, body53.externalSyncIdentifier) &&
        Objects.equals(this.description, body53.description) &&
        Objects.equals(this.invitabilityLevel, body53.invitabilityLevel) &&
        Objects.equals(this.memberViewabilityLevel, body53.memberViewabilityLevel);
  }
