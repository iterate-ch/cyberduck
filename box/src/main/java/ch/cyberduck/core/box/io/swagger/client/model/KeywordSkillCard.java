...
import ch.cyberduck.core.box.io.swagger.client.model.KeywordSkillCardEntries;
import ch.cyberduck.core.box.io.swagger.client.model.KeywordSkillCardSkillCardTitle;
 ...
 */
@Schema(description = "A skill card that contains a set of keywords")
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-01-25T11:35:18.602705+01:00[Europe/Zurich]")
public class KeywordSkillCard implements OneOfbody13CardsItems, OneOfSkillCardsMetadataCardsItems, OneOfskillInvocationsskillIdMetadataCardsItems {
  ...
  private KeywordSkillCardSkillCardTitle skillCardTitle = null;
  ...
  private List<KeywordSkillCardEntries> entries = new ArrayList<>();

  public KeywordSkillCard createdAt(DateTime createdAt) {
  ...
  **/
  @Schema(example = "keyword", required = true, description = "`keyword`")
  ...
  **/
  ...
  public KeywordSkillCard skill(SkillCardSkill skill) {
    this.skill = skill;
    return this;
  }
  ...
  **/
  ...
  public KeywordSkillCard invocation(SkillCardInvocation invocation) {
  ...
  **/
  ...
  public KeywordSkillCard entries(List<KeywordSkillCardEntries> entries) {
    this.entries = entries;
    return this;
  }

  public KeywordSkillCard addEntriesItem(KeywordSkillCardEntries entriesItem) {
   ...
   * @return entries
  **/
  @Schema(required = true, description = "An list of entries in the metadata card.")
  public List<KeywordSkillCardEntries> getEntries() {
    return entries;
  }

  public void setEntries(List<KeywordSkillCardEntries> entries) {
    this.entries = entries;
  }
