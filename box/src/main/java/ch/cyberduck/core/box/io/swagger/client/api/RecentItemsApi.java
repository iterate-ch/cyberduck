...
import ch.cyberduck.core.box.io.swagger.client.model.RecentItems;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-01-25T11:35:18.602705+01:00[Europe/Zurich]")public class RecentItemsApi {
  private ApiClient apiClient;

  public RecentItemsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public RecentItemsApi(ApiClient apiClient) {
   ...
   */
  public RecentItems getRecentItems(List<String> fields, Long limit, String marker) throws ApiException {
    ...
    GenericType<RecentItems> localVarReturnType = new GenericType<RecentItems>() {};
