...
public class Body56 {
  ...
  public Body56 target(WebhooksTarget target) {
    this.target = target;
    return this;
  }
  ...
  **/
  ...
  public Body56 address(String address) {
   ...
   * @return address
  **/
  @Schema(example = "https://example.com/webhooks", required = true, description = "The URL that is notified by this webhook")
  ...
  public Body56 triggers(List<TriggersEnum> triggers) {
    this.triggers = triggers;
    return this;
  }

  public Body56 addTriggersItem(TriggersEnum triggersItem) {
   ...
   * @return triggers
  **/
  @Schema(example = "[\"FILE.UPLOADED\"]", required = true, description = "An array of event names that this webhook is to be triggered for")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Body56 body56 = (Body56) o;
    return Objects.equals(this.target, body56.target) &&
        Objects.equals(this.address, body56.address) &&
        Objects.equals(this.triggers, body56.triggers);
  }
