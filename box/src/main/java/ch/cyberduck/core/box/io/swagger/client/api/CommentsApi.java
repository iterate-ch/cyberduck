...
import ch.cyberduck.core.box.io.swagger.client.model.Body30;
import ch.cyberduck.core.box.io.swagger.client.model.Body31;
...
import ch.cyberduck.core.box.io.swagger.client.model.Comments;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-01-25T11:35:18.602705+01:00[Europe/Zurich]")public class CommentsApi {
   ...
   */
  public void deleteCommentsId(String commentId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'commentId' is set
    if (commentId == null) {
      throw new ApiException(400, "Missing the required parameter 'commentId' when calling deleteCommentsId");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public Comment getCommentsId(String commentId, List<String> fields) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'commentId' is set
    if (commentId == null) {
      throw new ApiException(400, "Missing the required parameter 'commentId' when calling getCommentsId");
    }
    // create path and map variables
    String localVarPath = "/comments/{comment_id}"
      .replaceAll("\\{" + "comment_id" + "\\}", apiClient.escapeString(commentId.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public Comments getFilesIdComments(String fileId, List<String> fields, Long limit, Long offset) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'fileId' is set
    if (fileId == null) {
      throw new ApiException(400, "Missing the required parameter 'fileId' when calling getFilesIdComments");
    }
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public Comment postComments(Body31 body, List<String> fields) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Comment putCommentsId(String commentId, Body30 body, List<String> fields) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'commentId' is set
    if (commentId == null) {
      throw new ApiException(400, "Missing the required parameter 'commentId' when calling putCommentsId");
    }
    // create path and map variables
    String localVarPath = "/comments/{comment_id}"
      .replaceAll("\\{" + "comment_id" + "\\}", apiClient.escapeString(commentId.toString()));
