...
public class FilesfileIdaddSharedLinkSharedLink {
   ...
   * @return access
  **/
  @Schema(example = "open", description = "The level of access for the shared link. This can be restricted to anyone with the link (`open`), only people within the company (`company`) and only those who have been invited to the file (`collaborators`).  If not set, this field defaults to the access level specified by the enterprise admin. To create a shared link with this default setting pass the `shared_link` object with no `access` field, for example `{ \"shared_link\": {} }`.  The `company` access level is only available to paid accounts.")
  ...
  public FilesfileIdaddSharedLinkSharedLink password(String password) {
  ...
  **/
  ...
  public FilesfileIdaddSharedLinkSharedLink vanityName(String vanityName) {
  ...
  **/
  ...
  public FilesfileIdaddSharedLinkSharedLink unsharedAt(DateTime unsharedAt) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FilesfileIdaddSharedLinkSharedLink filesfileIdaddSharedLinkSharedLink = (FilesfileIdaddSharedLinkSharedLink) o;
    return Objects.equals(this.access, filesfileIdaddSharedLinkSharedLink.access) &&
        Objects.equals(this.password, filesfileIdaddSharedLinkSharedLink.password) &&
        Objects.equals(this.vanityName, filesfileIdaddSharedLinkSharedLink.vanityName) &&
        Objects.equals(this.unsharedAt, filesfileIdaddSharedLinkSharedLink.unsharedAt) &&
        Objects.equals(this.permissions, filesfileIdaddSharedLinkSharedLink.permissions);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilesfileIdaddSharedLinkSharedLink {\n");
