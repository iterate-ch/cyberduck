 ...
 */
@Schema(description = "Sets the status of the skill. This can be used to show a message to the user while the Skill is processing the data, or if it was not able to process the file.")
...
public class StatusSkillCardStatus {
  ...
  public StatusSkillCardStatus code(CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public StatusSkillCardStatus message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StatusSkillCardStatus statusSkillCardStatus = (StatusSkillCardStatus) o;
    return Objects.equals(this.code, statusSkillCardStatus.code) &&
        Objects.equals(this.message, statusSkillCardStatus.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusSkillCardStatus {\n");
