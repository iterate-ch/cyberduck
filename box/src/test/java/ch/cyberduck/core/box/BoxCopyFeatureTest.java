...
public class BoxCopyFeatureTest extends AbstractBoxTest {
    ...
    public void testCopyFile() throws Exception {
        ...
        new BoxCopyFeature(session, fileid).copy(test, copy, new TransferStatus(), new DisabledConnectionCallback(), StreamListener.noop);
    ...
    public void testCopyOverride() throws Exception {
        ...
        new BoxCopyFeature(session, fileid).copy(test, copy, new TransferStatus().setExists(true).setRemote(existing.attributes()), new DisabledConnectionCallback(), StreamListener.noop);
    ...
    public void testCopyDirectory() throws Exception {
        ...
        new BoxCopyFeature(session, fileid).copy(directory, copy, new TransferStatus(), new DisabledConnectionCallback(), StreamListener.noop);
