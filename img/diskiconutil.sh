for PROTOCOL in "ftp" "s3" "swift" "googlestorage" "googledrive" "azure" "dropbox" "onedrive"; do
    ...
    sips -s format png -z 64 64   -s dpiHeight 72.0 -s dpiWidth 72.0   "$PROTOCOL@2x.png" --out $PROTOCOL.iconset/icon_64x64.png
    sips -s format png -z 128 128   -s dpiHeight 144.0 -s dpiWidth 144.0 "$PROTOCOL@2x.png" --out $PROTOCOL.iconset/icon_64x64@2x.png
    ...
    tiffutil -cathidpicheck $PROTOCOL.iconset/icon_64x64.png $PROTOCOL.iconset/icon_64x64@2x.png -out $PROTOCOL.tiff
done;