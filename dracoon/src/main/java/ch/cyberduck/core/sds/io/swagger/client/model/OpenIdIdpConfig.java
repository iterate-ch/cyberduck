 ...
 */
@ApiModel(description = "OpenID Connect IDP configuration")
...
public class OpenIdIdpConfig {
  ...
  /**
   * Flow, which is used at authentication  [Since version 4.11.0]
   */
  ...
  **/
   ...
   * @return flow
  **/
  @ApiModelProperty(example = "authorization_code", value = "Flow, which is used at authentication  [Since version 4.11.0]")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, issuer, authorizationEndPointUrl, tokenEndPointUrl, userInfoEndPointUrl, jwksEndPointUrl, clientId, clientSecret, flow, scopes, redirectUris, pkceEnabled, pkceChallengeMethod, mappingClaim, fallbackMappingClaim, userImportEnabled, userImportGroup, userUpdateEnabled, userManagementUrl);
  }
