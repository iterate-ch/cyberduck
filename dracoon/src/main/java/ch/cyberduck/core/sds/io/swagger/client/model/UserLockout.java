 ...
 */
@ApiModel(description = "User lockout information")
...
public class UserLockout {
   ...
   * @return enabled
  **/
  @ApiModelProperty(required = true, value = "Determines whether user lockout is enabled")
  ...
  **/
  @ApiModelProperty(value = "Maximum allowed number of failed login attempts")
  ...
  **/
  @ApiModelProperty(value = "Amount of minutes a user has to wait to make another login attempt after `maxNumberOfLoginFailures` has been exceeded")
