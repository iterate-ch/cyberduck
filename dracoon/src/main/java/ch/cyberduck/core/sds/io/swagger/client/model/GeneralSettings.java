...
public class GeneralSettings {
  ...
  **/
  @Schema(description = "Defines if S3 tags are enabled")
  ...
  **/
  @Schema(description = "Allow weak password  * A weak password has to fulfill the following criteria:     * is at least 8 characters long     * contains letters and numbers  * A strong password has to fulfill the following criteria in addition:     * contains at least one special character     * contains upper and lower case characters  Please use `GET /system/config/policies/passwords` API to get configured password policies.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sharePasswordSmsEnabled, cryptoEnabled, emailNotificationButtonEnabled, eulaEnabled, useS3Storage, s3TagsEnabled, hideLoginInputFields, authTokenRestrictions, mediaServerEnabled, weakPasswordEnabled);
  }
