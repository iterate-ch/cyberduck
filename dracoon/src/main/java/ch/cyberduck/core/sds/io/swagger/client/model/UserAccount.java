...
public class UserAccount {
  ...
  @JsonProperty("automaticallySubscribeDatarooms")
  private Boolean automaticallySubscribeDatarooms = null;
  ...
  **/
   ...
   * @return language
  **/
  @Schema(required = true, description = "IETF language tag")
  ...
  **/
   ...
   * @return mustSetEmail
  **/
  @Schema(description = "If `true`, the user must set the `email` at the first login.")
  ...
  **/
  ...
  public UserAccount createdAt(DateTime createdAt) {
  ...
  **/
  ...
  public UserAccount automaticallySubscribeDatarooms(Boolean automaticallySubscribeDatarooms) {
    this.automaticallySubscribeDatarooms = automaticallySubscribeDatarooms;
    return this;
  }

   /**
   * Automatically subscribe datarooms when getting permissions
   * @return automaticallySubscribeDatarooms
  **/
  @Schema(description = "Automatically subscribe datarooms when getting permissions")
  public Boolean isAutomaticallySubscribeDatarooms() {
    return automaticallySubscribeDatarooms;
  }

  public void setAutomaticallySubscribeDatarooms(Boolean automaticallySubscribeDatarooms) {
    this.automaticallySubscribeDatarooms = automaticallySubscribeDatarooms;
  }
  ...
  **/
  @Schema(description = "Last successful logon IP address")
  ...
  **/
  @Schema(description = "Last failed logon IP address")
  ...
  **/
  @Schema(description = "If `true`, the user must change the `userName` at the first login.")
  ...
  public UserAccount addAuthMethodsItem(UserAuthMethod authMethodsItem) {
   ...
   /**
   * Authentication methods:  * &#x60;sql&#x60;  * &#x60;active_directory&#x60;  * &#x60;openid&#x60;  use &#x60;authData&#x60; instead
   * @return authMethods
  **/
  @Schema(description = "Authentication methods:  * `sql`  * `active_directory`  * `openid`  use `authData` instead")
  ...
  **/
  ...
  public UserAccount lockStatus(Integer lockStatus) {
   ...
   /**
   * User lock status:  * &#x60;0&#x60; - locked  * &#x60;1&#x60; - Web access allowed  * &#x60;2&#x60; - Web and mobile access allowed    Please use &#x60;isLocked&#x60; instead.
   * @return lockStatus
  **/
  @Schema(required = true, description = "User lock status:  * `0` - locked  * `1` - Web access allowed  * `2` - Web and mobile access allowed    Please use `isLocked` instead.")
  ...
  **/
  @Schema(required = true, description = "Determines whether user has to change his / her password")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, userAccount.id) &&
        ...
        Objects.equals(this.automaticallySubscribeDatarooms, userAccount.automaticallySubscribeDatarooms) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userName, firstName, lastName, isLocked, hasManageableRooms, userRoles, language, authData, mustSetEmail, needsToAcceptEULA, expireAt, isEncryptionEnabled, lastLoginSuccessAt, lastLoginFailAt, email, phone, homeRoomId, createdAt, automaticallySubscribeDatarooms, userGroups, userAttributes, title, lastLoginSuccessIp, lastLoginFailIp, gender, needsToChangeUserName, authMethods, login, lockStatus, needsToChangePassword);
  }
  ...
  public String toString() {
    ...
    sb.append("    automaticallySubscribeDatarooms: ").append(toIndentedString(automaticallySubscribeDatarooms)).append("\n");
