...
public class UpdateAuthTokenRestrictions {
  ...
  **/
  @Schema(required = true, description = "Defines if OAuth token restrictions are enabled")
  ...
  **/
  @Schema(description = "Restricted OAuth access token validity (in seconds)")
  ...
  **/
  @Schema(description = "Restricted OAuth refresh token validity (in seconds)")
