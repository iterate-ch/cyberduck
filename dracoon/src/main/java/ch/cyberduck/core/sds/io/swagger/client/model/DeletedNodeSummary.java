...
public class DeletedNodeSummary {
  ...
  private java.util.Date firstDeletedAt = null;

  @JsonProperty("lastDeletedAt")
  private java.util.Date lastDeletedAt = null;
  ...
  **/
  ...
  public DeletedNodeSummary firstDeletedAt(java.util.Date firstDeletedAt) {
  ...
  **/
  @ApiModelProperty(required = true, value = "First deleted version (2015-12-31T23:59:00)")
  public java.util.Date getFirstDeletedAt() {
    return firstDeletedAt;
  }

  public void setFirstDeletedAt(java.util.Date firstDeletedAt) {
    this.firstDeletedAt = firstDeletedAt;
  }

  public DeletedNodeSummary lastDeletedAt(java.util.Date lastDeletedAt) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Last deleted version (2015-12-31T23:59:00)")
  public java.util.Date getLastDeletedAt() {
    return lastDeletedAt;
  }

  public void setLastDeletedAt(java.util.Date lastDeletedAt) {
    this.lastDeletedAt = lastDeletedAt;
  }
