...
public class UserData {
  ...
  **/
  ...
  public UserAttributes getUserAttributes() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, login, firstName, lastName, isLocked, authMethods, email, avatarUuid, lockStatus, phone, title, gender, expireAt, hasManageableRooms, isEncryptionEnabled, lastLoginSuccessAt, publicKeyContainer, userRoles, userAttributes, homeRoomId);
  }
