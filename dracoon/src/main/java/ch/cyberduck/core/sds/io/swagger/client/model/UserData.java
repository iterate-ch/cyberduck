...
public class UserData {
  ...
  **/
  ...
  public UserData expireAt(java.util.Date expireAt) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, login, title, firstName, lastName, gender, email, lockStatus, expireAt, hasManageableRooms, isEncryptionEnabled, publicKeyContainer, userRoles, userAttributes, authMethods);
  }
