...
public class SettingsApi {
   ...
   */
  public void createAndPreserveKeyPair(CreateKeyPairRequest body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Webhook createWebhook(CreateWebhookRequest body, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
  ...
  /**
   * Remove webhook
   * ### Description:   Delete a webhook for the customer scope.  ### Precondition: Right &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change config&lt;/span&gt; required.  ### Postcondition: Webhook is deleted.  ### Further Information: None.
   * @param webhookId Webhook ID (required)
   * @throws ApiException if fails to make API call
   */
  public void removeWebhook(Long webhookId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public List<UserKeyPairContainer> requestAllSystemRescueKeyPairs(String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/settings/keypairs";
   ...
   * @throws ApiException if fails to make API call
   */
  public WebhookList requestListOfWebhooks(String xSdsDateFormat, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/settings/webhooks";
   ...
   * ### Description:   Retrieve a list of configured notification channels.  ### Precondition: Right _\&quot;change config\&quot;_ required.  ### Postcondition: List of notification channels is returned.  ### Further Information: None. 
   * @return NotificationChannelList
   * @throws ApiException if fails to make API call
   */
  public NotificationChannelList requestNotificationChannels() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public CustomerSettingsResponse requestSettings() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public UserKeyPairContainer requestSystemRescueKeyPair(String xSdsDateFormat, String version) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/settings/keypair";
  ...
  /**
   * Request webhook
   * ### Description:   Get a specific webhook for the customer scope.  ### Precondition: Right &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change config&lt;/span&gt; required.  ### Postcondition: Webhook is returned.  ### Further Information: None.
   * @param webhookId Webhook ID (required)
   * @param xSdsDateFormat Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) &amp; [leettime.de](http://leettime.de/)) (optional)
   * @return Webhook
   * @throws ApiException if fails to make API call
   */
  public Webhook requestWebhook(Long webhookId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'webhookId' is set
    if (webhookId == null) {
   ...
   * ### Description:   Reset the lifetime of a webhook for the customer scope.  ### Precondition: Right &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change config&lt;/span&gt; required.  ### Postcondition: Lifetime of the webhook is reset.  ### Further Information: None.
   * @param webhookId Webhook ID (required)
   * @param xSdsDateFormat Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) &amp; [leettime.de](http://leettime.de/)) (optional)
   * @return Webhook
   * @throws ApiException if fails to make API call
   */
  public Webhook resetWebhookLifetime(Long webhookId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'webhookId' is set
    if (webhookId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public CustomerSettingsResponse setSettings(CustomerSettingsRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * ### Description:   Toggle configured notification channels.  ### Precondition: Right _\&quot;change config\&quot;_ required.  ### Postcondition: Channel status is switched.  ### Further Information: None. 
   * @param body  (required)
   * @return NotificationChannelList
   * @throws ApiException if fails to make API call
   */
  public NotificationChannelList toggleNotificationChannels(NotificationChannelActivationRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Webhook updateWebhook(UpdateWebhookRequest body, Long webhookId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
