...
/**
 * Request model for updating mail server settings
 */
@ApiModel(description = "Request model for updating mail server settings")
...
public class UpdateMailServerConfig {
  ...
  **/
   @ApiModelProperty(value = "Set `true` if the email server requires authentication.")
   ...
   * @return sslEnabled
  **/
   @ApiModelProperty(value = "Email server requires SSL connection? Requires `starttlsEnabled` to be `false`")
  ...
  **/
   @ApiModelProperty(value = "Email server requires StartTLS connection? Requires `sslEnabled` to be `false`")
  ...
  **/
   @ApiModelProperty(value = "Set `true` to reset email server `username`.")
  ...
  **/
   @ApiModelProperty(value = "Set `true` to reset email server `password`.")
