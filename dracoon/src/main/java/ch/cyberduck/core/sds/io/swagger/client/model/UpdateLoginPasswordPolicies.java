...
public class UpdateLoginPasswordPolicies {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(characterRules, minLength, rejectDictionaryWords, rejectUserInfo, rejectKeyboardPatterns, numberOfArchivedPasswords, passwordExpiration, userLockout);
  }
