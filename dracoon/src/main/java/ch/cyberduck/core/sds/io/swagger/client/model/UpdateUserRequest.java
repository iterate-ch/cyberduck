...
public class UpdateUserRequest {
  ...
  **/
   ...
   * @return isLocked
  **/
   @ApiModelProperty(value = "User is locked: * `false` - unlocked * `true` - locked  Iser is locked and can not login anymore. (default: `false`)")
  ...
  **/
  ...
  @Override
  public int hashCode() {
      return Objects.hash(title, firstName, lastName, gender, isLocked, expiration, authMethods, email, phone, receiverLanguage, lockStatus);
  }
