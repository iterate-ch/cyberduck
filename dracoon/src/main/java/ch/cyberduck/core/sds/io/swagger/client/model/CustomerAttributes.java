 ...
 */
@Schema(description = "List of customer attributes")
...
public class CustomerAttributes {
  ...
  public CustomerAttributes items(List<KeyValueEntry> items) {
    this.items = items;
    return this;
  }

  public CustomerAttributes addItemsItem(KeyValueEntry itemsItem) {
   ...
   * @return items
  **/
  @Schema(required = true, description = "List of customer attributes")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.items, customerAttributes.items);
  }
