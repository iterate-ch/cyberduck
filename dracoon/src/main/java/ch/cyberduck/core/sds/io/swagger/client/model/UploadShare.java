...
public class UploadShare {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, targetId, isProtected, accessKey, notifyCreator, createdAt, createdBy, expireAt, targetPath, isEncrypted, notes, filesExpiryPeriod, recipients, smsRecipients, cntFiles, cntUploads, showUploadedFiles, dataUrl, maxSlots, maxSize);
  }
