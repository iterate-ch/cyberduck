 ...
 */
@Schema(description = "List of deleted versions of nodes")
...
public class DeletedNodeVersionsList {
  ...
  @JsonProperty("items")
  private List<DeletedNode> items = new ArrayList<>();
  ...
  **/
  ...
  public DeletedNodeVersionsList addItemsItem(DeletedNode itemsItem) {
   ...
   * @return items
  **/
  @Schema(required = true, description = "List of deleted nodes")
