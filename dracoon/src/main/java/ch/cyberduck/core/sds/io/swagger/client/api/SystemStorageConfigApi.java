...
public class SystemStorageConfigApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public S3Config request3Config() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/storage/s3";
   ...
   * @throws ApiException if fails to make API call
   */
  public S3Tag requestS3Tag(Long id) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public S3TagList requestS3TagList() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/storage/s3/tags";
