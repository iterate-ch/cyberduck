...
public class EncryptRoomRequest {
   ...
   * @return isEncrypted
  **/
  @ApiModelProperty(required = true, value = "Set true to encrypt a room")
  ...
  **/
  @ApiModelProperty(value = "Use DataSpace Rescue key for files in this room")
  ...
  **/
  @ApiModelProperty(value = "Set DataRoom Rescue Key for files in this room")
