 ...
 */
@ApiModel(description = "Request model for handling encryption settings for a room")
...
public class EncryptRoomRequest {
  ...
  **/
  @ApiModelProperty(value = "Use system emergency password (rescue key) for files in this room")
