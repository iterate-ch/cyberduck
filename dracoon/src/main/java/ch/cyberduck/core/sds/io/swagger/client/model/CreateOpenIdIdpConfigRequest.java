...
public class CreateOpenIdIdpConfigRequest {
  ...
  **/
   ...
   * @return issuer
  **/
  @ApiModelProperty(required = true, value = "Issuer identifier of the IDP. (The value is a case sensitive URL.)")
  ...
  **/
  @ApiModelProperty(required = true, value = "URL of the Authorization Endpoint.")
  ...
  **/
  @ApiModelProperty(required = true, value = "URL of the Token Endpoint.")
  ...
  **/
  @ApiModelProperty(required = true, value = "URL of the User Info Endpoint.")
  ...
  **/
  @ApiModelProperty(required = true, value = "URL of the JWKS Endpoint.")
  ...
  **/
   ...
   * @return redirectUris
  **/
  @ApiModelProperty(required = true, value = "List of redirection URIs.")
  ...
  **/
   ...
   * @return mappingClaim
  **/
  @ApiModelProperty(required = true, value = "Name of the claim which is used for the user mapping. (E.g. 'email'.)")
