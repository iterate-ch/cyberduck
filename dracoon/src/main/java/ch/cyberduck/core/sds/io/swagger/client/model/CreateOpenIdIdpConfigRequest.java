...
public class CreateOpenIdIdpConfigRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, issuer, authorizationEndPointUrl, tokenEndPointUrl, userInfoEndPointUrl, jwksEndPointUrl, clientId, clientSecret, scopes, redirectUris, mappingClaim, pkceEnabled, pkceChallengeMethod, fallbackMappingClaim, userUpdateEnabled);
  }
