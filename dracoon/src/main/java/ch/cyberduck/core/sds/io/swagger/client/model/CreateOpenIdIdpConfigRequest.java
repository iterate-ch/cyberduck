...
public class CreateOpenIdIdpConfigRequest {
  ...
  **/
   ...
   * @return scopes
     **/
    @ApiModelProperty(required = true, value = "List of requested scopes Usually `openid` and the names of the requested claims.")
  ...
  **/
  ...
  public CreateOpenIdIdpConfigRequest userUpdateEnabled(Boolean userUpdateEnabled) {
    ...
    /**
     * Determines if the DRACOON account is updated with data from AD / IDP. For OpenID, the scopes &#x60;email&#x60; and &#x60;profile&#x60; are needed. (default: &#x60;false&#x60;)
     *
     * @return userUpdateEnabled
     **/
    @ApiModelProperty(example = "false", value = "Determines if the DRACOON account is updated with data from AD / IDP. For OpenID, the scopes `email` and `profile` are needed. (default: `false`)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, issuer, authorizationEndPointUrl, tokenEndPointUrl, userInfoEndPointUrl, jwksEndPointUrl, clientId, clientSecret, scopes, redirectUris, mappingClaim, pkceEnabled, pkceChallengeMethod, fallbackMappingClaim, userImportEnabled, userImportGroup, userUpdateEnabled);
  }
