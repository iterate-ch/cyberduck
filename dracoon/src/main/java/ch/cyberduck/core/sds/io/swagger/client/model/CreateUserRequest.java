...
public class CreateUserRequest {
  ...
  **/
   ...
   * @return notifyUser
  **/
  @Schema(description = "Notify user about his new account  * default: `true` for `basic` auth type  * default: `false` for `active_directory`, `openid` auth types")
  ...
  **/
  @Schema(description = "Determines whether user has the role NONMEMBER_VIEWER")
  ...
  **/
  ...
  public CreateUserRequest password(String password) {
   ...
   /**
   * An initial password may be preset  use &#x60;authData&#x60; instead
   * @return password
  **/
  @Schema(description = "An initial password may be preset  use `authData` instead")
  ...
  **/
  ...
  public CreateUserRequest needsToChangePassword(Boolean needsToChangePassword) {
   ...
   /**
   * Determines whether user has to change his / her initial password.  use &#x60;authDate.mustChangePassword&#x60; instead
   * @return needsToChangePassword
  **/
  @Schema(description = "Determines whether user has to change his / her initial password.  use `authDate.mustChangePassword` instead")
