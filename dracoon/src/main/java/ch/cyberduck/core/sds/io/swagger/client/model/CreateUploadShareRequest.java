...
public class CreateUploadShareRequest {
  ...
  **/
  @Schema(description = "Notify creator on every upload.")
  ...
  **/
  ...
  public CreateUploadShareRequest sendMail(Boolean sendMail) {
   ...
   /**
   * Notify recipients via email  Please use &#x60;POST /shares/uploads/{share_id}/email&#x60; API instead.
   * @return sendMail
  **/
  @Schema(description = "Notify recipients via email  Please use `POST /shares/uploads/{share_id}/email` API instead.")
