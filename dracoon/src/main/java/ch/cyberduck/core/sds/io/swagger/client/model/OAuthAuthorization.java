...
public class OAuthAuthorization {
  ...
  public enum UserAgentCategoryEnum {
    ...
    @JsonCreator
    public static UserAgentCategoryEnum fromValue(String input) {
  ...
  **/
  @Schema(required = true, description = "User agent category.")
   ...
   * @return id
  **/
  @Schema(description = "ID of the OAuth authorization")
  public Long getId() {
    return id;
  }
  ...
  **/
   ...
   * @return createdAt
  **/
  @Schema(description = "Creation date of the authorization")
  ...
  public OAuthAuthorization usedAt(DateTime usedAt) {
   ...
   /**
   * Usage date of the authorization  (Time of last usage.)
   * @return usedAt
  **/
  @Schema(description = "Usage date of the authorization  (Time of last usage.)")
  ...
  **/
  @Schema(description = "User agent type.")
   ...
   * @return userAgentOs
  **/
  @Schema(description = "User agent OS.")
  ...
  **/
  @Schema(description = "User agent info.")
  ...
  **/
  @Schema(description = "Determines whether authorization matches the one from Authorization Header")
