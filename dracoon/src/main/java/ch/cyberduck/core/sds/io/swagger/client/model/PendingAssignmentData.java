...
public class PendingAssignmentData {
  ...
  **/
  ...
  public PendingAssignmentData userId(Long userId) {
   ...
   /**
   * &amp;#128679; Deprecated since v4.2.0  Unique identifier for the user
   * @return userId
  **/
  @Schema(description = "&#128679; Deprecated since v4.2.0  Unique identifier for the user")
  ...
  public PendingAssignmentData groupId(Long groupId) {
   ...
   /**
   * &amp;#128679; Deprecated since v4.2.0  Unique identifier for the group
   * @return groupId
  **/
  @Schema(description = "&#128679; Deprecated since v4.2.0  Unique identifier for the group")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(roomId, roomName, state, userInfo, groupInfo, pendingUserData, pendingGroupData, userId, groupId);
  }
