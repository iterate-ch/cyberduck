...
public class PendingAssignmentData {
  ...
  **/
  ...
  public void setState(StateEnum state) {
    ...
    /**
     * DEPRECATEDInformation about pending users use &#x60;userInfo&#x60; instead  [Deprecated since version 4.11.0]
     *
     * @return pendingUserData
     **/
    @ApiModelProperty(required = true, value = "DEPRECATEDInformation about pending users use `userInfo` instead  [Deprecated since version 4.11.0]")
    ...
    /**
     * DEPRECATEDInformation about group with pending assignment option use &#x60;groupInfo&#x60; instead  [Deprecated since version 4.11.0]
     *
     * @return pendingGroupData
     **/
    @ApiModelProperty(required = true, value = "DEPRECATEDInformation about group with pending assignment option use `groupInfo` instead  [Deprecated since version 4.11.0]")
  ...
  public PendingAssignmentData userId(Long userId) {
    ...
    /**
     * DEPRECATEDUnique identifier for the user use &#x60;id&#x60; from &#x60;UserInfo&#x60; instead  [Deprecated since version 4.2.0]
     * @return userId
     **/
    @ApiModelProperty(value = "DEPRECATEDUnique identifier for the user use `id` from `UserInfo` instead  [Deprecated since version 4.2.0]")
  ...
  public PendingAssignmentData groupId(Long groupId) {
    ...
    /**
     * DEPRECATEDUnique identifier for the group use &#x60;id&#x60; from &#x60;GroupInfo&#x60; instead  [Deprecated since version 4.2.0]
     * @return groupId
     **/
    @ApiModelProperty(value = "DEPRECATEDUnique identifier for the group use `id` from `GroupInfo` instead  [Deprecated since version 4.2.0]")
