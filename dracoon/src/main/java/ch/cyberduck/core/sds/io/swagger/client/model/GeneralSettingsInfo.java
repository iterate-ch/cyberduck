...
public class GeneralSettingsInfo {
  ...
  **/
  ...
  public GeneralSettingsInfo subscriptionPlan(Integer subscriptionPlan) {
  ...
  **/
  @Schema(description = "&#128640; Since v4.30.0  Subscription Plan")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sharePasswordSmsEnabled, cryptoEnabled, emailNotificationButtonEnabled, eulaEnabled, weakPasswordEnabled, useS3Storage, s3TagsEnabled, homeRoomsActive, homeRoomParentId, mediaServerEnabled, subscriptionPlan);
  }
