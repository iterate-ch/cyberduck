...
public class DownloadShare {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, nodeId, accessKey, cntDownloads, createdAt, createdBy, updatedAt, updatedBy, notes, internalNotes, showCreatorName, showCreatorUsername, isProtected, expireAt, maxDownloads, nodePath, dataUrl, isEncrypted, nodeType, notifyCreator, classification, recipients, smsRecipients);
  }
