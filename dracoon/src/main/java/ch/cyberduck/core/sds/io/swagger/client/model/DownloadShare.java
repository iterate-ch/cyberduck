...
public class DownloadShare {
  ...
  **/
  @ApiModelProperty(value = "File classification.")
  ...
  **/
  @ApiModelProperty(value = "Show creator First Name and Last Name")
  ...
  **/
  ...
  public DownloadShare expireAt(java.util.Date expireAt) {
  ...
  **/
  ...
  public DownloadShare createdAt(java.util.Date createdAt) {
  ...
  **/
   ...
   * @return isEncrypted
  **/
  @ApiModelProperty(value = "Encrypted share (this only applies to shared files, not folders) <b style='color: green;'>&nbsp;NEW</b>")
