...
public class UserItem {
  ...
  **/
  ...
  public String getPhone() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, login, firstName, lastName, isLocked, hasManageableRooms, userRoles, lockStatus, title, gender, createdAt, lastLoginSuccessAt, expireAt, isEncryptionEnabled, userAttributes, email, phone, homeRoomId);
  }
