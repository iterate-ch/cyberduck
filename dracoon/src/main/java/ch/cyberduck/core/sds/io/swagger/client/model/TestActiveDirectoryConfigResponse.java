 ...
 */
@Schema(description = "Response model for testing connection for Active Directory configuration")
...
public class TestActiveDirectoryConfigResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(serverIp, serverPort, serverAdminName, ldapUsersDomain, useLdaps, sslFingerPrint);
  }
