...
import ch.cyberduck.core.sds.io.swagger.client.model.NodeAttributes;
...
public class NodesApi {
   ...
   */
  public Node addFavorite(Long nodeId, String xSdsDateFormat) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void addRoomGuestUsers(RoomGuestUserAddRequest body, Long roomId) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void cancelFileUpload(String uploadId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void changePendingAssignments(PendingAssignmentsRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   */
  @Deprecated
  public Node completeFileUpload(String uploadId, CompleteUploadRequest body, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'uploadId' is set
    if (uploadId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node configureRoom(ConfigRoomRequest body, Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node copyNodes(CopyNodesRequest body, Long nodeId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node createFolder(CreateFolderRequest body, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Comment createNodeComment(CreateNodeCommentRequest body, Long nodeId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node createRoom(CreateRoomRequest body, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   */
  @Deprecated
  public void downloadZipArchive(ZipDownloadRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void emptyDeletedNodes(Long nodeId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node encryptRoom(EncryptRoomRequest body, Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   */
  @Deprecated
  public DownloadTokenGenerateResponse generateDownloadUrlForZipArchive(ZipDownloadRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PresignedUrlList generatePresignedUrlsFiles(GeneratePresignedUrlsRequest body, String uploadId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<NodeVirusProtectionInfo> generateVirusProtectionInfo(VirusProtectionVerdictRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RoomWebhookList handleRoomWebhookAssignments(UpdateRoomWebhookRequest body, Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node moveNodes(MoveNodesRequest body, Long nodeId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeDeletedNodes(DeleteDeletedNodesRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeFavorite(Long nodeId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeMaliciousFile(Long maliciousFileId) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeNode(Long nodeId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
  ...
  /**
   * Remove custom node attribute
   * ### Description: Delete custom node attribute.  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change&lt;/span&gt; permissions in parent room (for folders or files) or needs to be a &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128100; Room Administrator&lt;/span&gt; (for rooms).  ### Postcondition: Custom node attribute is deleted.  ### Further Information: * Allowed characters for keys are: &#x60;[a-zA-Z0-9_-]&#x60;   * Characters are **case-insensitive**.
   * @param nodeId Node ID (required)
   * @param key Key (required)
   * @throws ApiException if fails to make API call
   */
  public void removeNodeAttribute(Long nodeId, String key) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
      throw new ApiException(400, "Missing the required parameter 'nodeId' when calling removeNodeAttribute");
    }
    // verify the required parameter 'key' is set
    if (key == null) {
      throw new ApiException(400, "Missing the required parameter 'key' when calling removeNodeAttribute");
    }
    // create path and map variables
    String localVarPath = "/v4/nodes/{node_id}/node_attributes/{key}"
      .replaceAll("\\{" + "node_id" + "\\}", apiClient.escapeString(nodeId.toString()))
   ...
   * @throws ApiException if fails to make API call
   */
  public void removeNodes(DeleteNodesRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * ### Description:   Delete room rescue key pair.  ### Precondition: Authenticated user.  ### Postcondition: Key pair is removed (cf. further information below).  ### Further Information: Please set a new room rescue key pair first and re-encrypt file keys with it.   If no version is set, deleted key pair with lowest preference value.   Although, &#x60;version&#x60; **SHOULD** be set. 
   * @param roomId Room ID (required)
   * @param version Version (NEW) (optional)
   * @throws ApiException if fails to make API call
   */
  public void removeRoomRescueKeyPair(Long roomId, String version) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public DeletedNode requestDeletedNode(Long deletedNodeId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public DeletedNodeVersionsList requestDeletedNodeVersions(Long nodeId, String type, String name, String xSdsDateFormat, String sort, Integer offset, Integer limit) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public DeletedNodeSummaryList requestDeletedNodesSummary(Long nodeId, String xSdsDateFormat, String filter, String sort, Integer offset, Integer limit) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public FileVersionList requestFileVersionList(Long referenceId, String xSdsDateFormat, Integer offset, Integer limit) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public RoomWebhookList requestListOfWebhooksForRoom(Long roomId, String xSdsDateFormat, Integer offset, Integer limit, String filter) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public MissingKeysResponse requestMissingFileKeys(Integer offset, Integer limit, Long roomId, Long fileId, Long userId, String useKey) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public Node requestNode(Long nodeId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
  ...
  /**
   * Request custom node attributes
   * ### Description:   Retrieve a list of node attributes.  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; read&lt;/span&gt; permissions in auth parent room.  ### Postcondition: List of attributes is returned.  ### Further Information:  ### Filtering: All filter fields are connected via logical conjunction (**AND**)   Filter string syntax: &#x60;FIELD_NAME:OPERATOR:VALUE[:VALUE...]&#x60;    &lt;details style&#x3D;\&quot;padding-left: 10px\&quot;&gt; &lt;summary style&#x3D;\&quot;cursor: pointer; outline: none\&quot;&gt;&lt;strong&gt;Example&lt;/strong&gt;&lt;/summary&gt;  &#x60;key:cn:searchString_1|value:cn:searchString_2&#x60;   Filter by attribute key contains &#x60;searchString_1&#x60; **AND** attribute value contains &#x60;searchString_2&#x60;.  &lt;/details&gt;  ### Filtering options: &lt;details style&#x3D;\&quot;padding: 10px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px;\&quot;&gt; &lt;summary style&#x3D;\&quot;cursor: pointer; outline: none\&quot;&gt;&lt;strong&gt;Expand&lt;/strong&gt;&lt;/summary&gt;  | &#x60;FIELD_NAME&#x60; | Filter Description          | &#x60;OPERATOR&#x60; | Operator Description | &#x60;VALUE&#x60; | | :--- |:----------------------------| :--- | :--- | :--- | | &#x60;key&#x60; | Node attribute key filter   | &#x60;cn, eq, sw&#x60; | Attribute key contains / equals / starts with value. | &#x60;search String&#x60; | | &#x60;value&#x60; | Node attribute value filter | &#x60;cn, eq, sw&#x60; | Attribute value contains / equals / starts with value. | &#x60;search String&#x60; |  &lt;/details&gt;  ---  ### Sorting: Sort string syntax: &#x60;FIELD_NAME:ORDER&#x60;   &#x60;ORDER&#x60; can be &#x60;asc&#x60; or &#x60;desc&#x60;.   Multiple sort fields are supported.    &lt;details style&#x3D;\&quot;padding-left: 10px\&quot;&gt; &lt;summary style&#x3D;\&quot;cursor: pointer; outline: none\&quot;&gt;&lt;strong&gt;Example&lt;/strong&gt;&lt;/summary&gt;  &#x60;key:asc|value:desc&#x60;   Sort by &#x60;key&#x60; ascending **AND** by &#x60;value&#x60; descending.  &lt;/details&gt;  ### Sorting options: &lt;details style&#x3D;\&quot;padding: 10px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px;\&quot;&gt; &lt;summary style&#x3D;\&quot;cursor: pointer; outline: none\&quot;&gt;&lt;strong&gt;Expand&lt;/strong&gt;&lt;/summary&gt;  | &#x60;FIELD_NAME&#x60; | Description | | :--- | :--- | | &#x60;key&#x60; | Node attribute key | | &#x60;value&#x60; | Node attribute value |  &lt;/details&gt;
   * @param nodeId Node ID (required)
   * @param offset Range offset (optional)
   * @param limit Range limit.  Maximum 500.   For more results please use paging (&#x60;offset&#x60; + &#x60;limit&#x60;). (optional)
   * @param filter Filter string (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public AttributesResponse requestNodeAttributes(Long nodeId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
      throw new ApiException(400, "Missing the required parameter 'nodeId' when calling requestNodeAttributes");
    }
    // create path and map variables
    String localVarPath = "/v4/nodes/{node_id}/node_attributes"
      .replaceAll("\\{" + "node_id" + "\\}", apiClient.escapeString(nodeId.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public CommentList requestNodeComments(Long nodeId, String xSdsDateFormat, Integer offset, Integer limit, Boolean hideDeleted) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * ### Description:   Requests a list of node ancestors, sorted from root node to the node&#x27;s direct parent node.  ### Precondition: User is allowed to browse through the node tree until the requested node.  ### Postcondition: List of parent nodes is returned.  ### Further Information: None.
   * @param nodeId Node ID (required)
   * @return NodeParentList
   * @throws ApiException if fails to make API call
   */
  public NodeParentList requestNodeParents(Long nodeId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
   ...
   * @param offset Range offset (optional)
   * @param limit Range limit.  Maximum 500.   For more results please use paging (&#x60;offset&#x60; + &#x60;limit&#x60;). (optional)
   * @param showSubscription Show subscription information (default: false) (optional)
   * @return NodeList
   * @throws ApiException if fails to make API call
   */
  public NodeList requestNodes(String xSdsDateFormat, Integer depthLevel, Long parentId, Boolean roomManager, String filter, String sort, Integer offset, Integer limit, Boolean showSubscription) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/nodes";
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "offset", offset));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "limit", limit));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "show_subscription", showSubscription));
   ...
   * @throws ApiException if fails to make API call
   */
  public PendingAssignmentList requestPendingAssignments(Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/nodes/rooms/pending";
   ...
   * @throws ApiException if fails to make API call
   */
  public LogEventList requestRoomActivitiesLogAsJson(Long roomId, String xSdsDateFormat, String sort, Integer offset, Integer limit, String dateStart, String dateEnd, Integer type, Long userId, Integer status) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RoomGroupList requestRoomGroups(Long roomId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * ### Description:   Retrieve the room policies: * &#x60;defaultExpirationPeriod&#x60; * &#x60;virusProtectionEnabled&#x60;  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; read&lt;/span&gt; permissions in that room.  ### Postcondition: Room Policies returned.  ### Further Information: &#x60;defaultExpirationPeriod&#x60;: Default policy room expiration period in seconds. All existing and future files in a room will have their expiration date set to this period after their respective upload. Existing files can be set to expire earlier afterwards. &#x60;0&#x60; means no default expiration policy will be enforced.   &#x60;virusProtectionEnabled&#x60;: Status of room policy for virus-protection. Can be activated for unencrypted data rooms. If enabled, the files are sent to the German IT security company G DATA CyberDefense for verification.  
   * @param roomId Room ID (required)
   * @return RoomPolicies
   * @throws ApiException if fails to make API call
   */
  public RoomPolicies requestRoomPolicies(Long roomId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   */
  @Deprecated
  public FileKey requestRoomRescueKey(Long fileId, String version) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'fileId' is set
    if (fileId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public UserKeyPairContainer requestRoomRescueKeyPair(Long roomId, String xSdsDateFormat, String version) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<UserKeyPairContainer> requestRoomRescueKeyPairs(Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * ### Description:   Retrieve a list of S3 tags assigned to a room.  ### Precondition: User needs to be a &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128100; Room Administrator&lt;/span&gt;.  ### Postcondition: List of assigned S3 tags is returned.  ### Further Information: None.
   * @param roomId Room ID (required)
   * @return S3TagList
   * @throws ApiException if fails to make API call
   */
  public S3TagList requestRoomS3Tags(Long roomId) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RoomUserList requestRoomUsers(Long roomId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'roomId' is set
    if (roomId == null) {
   ...
   */
  @Deprecated
  public FileKey requestSystemRescueKey(Long fileId, String version) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'fileId' is set
    if (fileId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public FileKey requestUserFileKey(Long fileId, String version) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'fileId' is set
    if (fileId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void restoreNodes(RestoreDeletedNodesRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void revokeRoomGroups(RoomGroupsDeleteBatchRequest body, Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void revokeRoomUsers(RoomUsersDeleteBatchRequest body, Long roomId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public NodeList searchNodes(String searchString, String xSdsDateFormat, Integer depthLevel, Long parentId, String filter, String sort, Integer offset, Integer limit, Boolean showSubscription) throws ApiException {
    Object localVarPostBody = null;
   ...
   * ### Description:   Set room rescue key pair.  ### Precondition: User needs to be a &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128100; Room Administrator&lt;/span&gt;.  ### Postcondition: Key pair is set.  ### Further Information: Room rescue key pair can be used to upgrade algorithm.
   * @param body  (required)
   * @param roomId Room ID (required)
   * @throws ApiException if fails to make API call
   */
  public void setRoomRescueKeyPair(UserKeyPairContainer body, Long roomId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void setUserFileKeys(UserFileKeySetBatchRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * ### Description: Updates a file’s metadata.  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change&lt;/span&gt; permissions in parent room.  ### Postcondition: File&#x27;s metadata is changed.   
   * @param body  (required)
   * @param fileId File ID (required)
   * @param xSdsDateFormat Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) &amp; [leettime.de](http://leettime.de/)) (optional)
   * @return Node
   * @throws ApiException if fails to make API call
   */
  public Node updateFile(UpdateFileRequest body, Long fileId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * ### Description:   Updates a list of file’s metadata.  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change&lt;/span&gt; permissions in parent room.  ### Postcondition: File&#x27;s metadata is changed.  ### Further Information: Maximum number of files is 200 
   * @param body  (required)
   * @throws ApiException if fails to make API call
   */
  public void updateFiles(UpdateFilesBulkRequest body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node updateFolder(UpdateFolderRequest body, Long folderId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * ### Description:   Add or edit custom node attributes.  ### Precondition: User has &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change&lt;/span&gt; permissions in parent room (for folders or files) or needs to be a &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128100; Room Administrator&lt;/span&gt; (for rooms).  ### Postcondition: Custom node attributes gets added or edited.  ### Further Information: Batch function.   If an entry exists before, it will be overwritten.    * Allowed characters for keys are: &#x60;[a-zA-Z0-9_-]&#x60; * Characters are **case-insensitive** * Maximum key length is **255** * Maximum value length is **4096** * Maximum number of entries is 200  The total number of attributes for a node is limited to **500**.
   * @param body  (required)
   * @param nodeId Node ID (required)
   * @throws ApiException if fails to make API call
   */
  public void updateNodeAttributes(NodeAttributes body, Long nodeId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateNodeAttributes");
    }
    // verify the required parameter 'nodeId' is set
    if (nodeId == null) {
      throw new ApiException(400, "Missing the required parameter 'nodeId' when calling updateNodeAttributes");
    }
    // create path and map variables
    String localVarPath = "/v4/nodes/{node_id}/node_attributes"
      .replaceAll("\\{" + "node_id" + "\\}", apiClient.escapeString(nodeId.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public Comment updateNodeComment(ChangeNodeCommentRequest body, Long commentId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public Node updateRoom(UpdateRoomRequest body, Long roomId, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateRoomGroups(RoomGroupsAddBatchRequest body, Long roomId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateRoomUsers(RoomUsersAddBatchRequest body, Long roomId) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
   ...
   */
  @Deprecated
  public ChunkUploadResponse uploadFileAsMultipart(String uploadId, File file, String contentRange) throws ApiException {
    Object localVarPostBody = null;
    // verify the required parameter 'uploadId' is set
    if (uploadId == null) {
