...
if (xSdsDateFormat != null)
    ...
    /**
     * Configure room
     * ### Functional Description: Configure a room.  ### Precondition: User needs to be a room administrator.  ### Effects: Room&#39;s configuration is changed.  ### &amp;#9432; Further Information: Provided (or default) classification is taken from room when file gets uploaded without any classification.
     * @param body body (required)
...
if (xSdsDateFormat != null)
     ...
     * ### &amp;#128640; Since version 4.10.0  ### Functional Description: Get comments for a specific node.  ### Precondition: User has _\&quot;read\&quot;_ permissions on the node.  ### Effects: List with comments (sorted by &#x60;createdAt&#x60; timestamp) is returned.  ### &amp;#9432; Further Information: An empty list is returned if no comments were found.
     *
     * @param nodeId         Node ID (required)
     * @param xSdsAuthToken  Authentication token (optional)
     * @param xSdsDateFormat Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt)) (optional)
     ...
     * @throws ApiException if fails to make API call
     */
    public CommentList getNodeComments(Long nodeId, String xSdsAuthToken, String xSdsDateFormat, Boolean hideDeleted) throws ApiException {
        return getNodeCommentsWithHttpInfo(nodeId, xSdsAuthToken, xSdsDateFormat, hideDeleted).getData();
    }
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<CommentList> getNodeCommentsWithHttpInfo(Long nodeId, String xSdsAuthToken, String xSdsDateFormat, Boolean hideDeleted) throws ApiException {
        Object localVarPostBody = null;
...
if (xSdsDateFormat != null)
     ...
     * @param body          body (required)
     * @param xSdsAuthToken Authentication token (optional)
     * @return NotRestoredNodeList
     * @throws ApiException if fails to make API call
     */
    public NotRestoredNodeList restoreNodes(RestoreDeletedNodesRequest body, String xSdsAuthToken) throws ApiException {
        return restoreNodesWithHttpInfo(body, xSdsAuthToken).getData();
    }
   ...
   * @param body body (required)
   * @param xSdsAuthToken Authentication token (optional)
   * @return ApiResponse&lt;NotRestoredNodeList&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NotRestoredNodeList> restoreNodesWithHttpInfo(RestoreDeletedNodesRequest body, String xSdsAuthToken) throws ApiException {
    Object localVarPostBody = body;
    ...
    Map<String, Object> localVarFormParams = new HashMap<String, Object>();
      ...
      GenericType<NotRestoredNodeList> localVarReturnType = new GenericType<NotRestoredNodeList>() {};
    return apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
   * Get room emergency password (rescue key)
