 ...
 */
@ApiModel(description = "Password character rules")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-04-08T17:57:49.759+02:00")
public class CharacterRules {
  /**
   * Gets or Sets mustContainCharacters
   */
  ...
  **/
  @ApiModelProperty(required = true, value = "Characters which a password must contain: * `alpha` - at least one alphabetical character (`uppercase` OR `lowercase`) * `uppercase` - at least one uppercase character * `lowercase` - at least one lowercase character * `numeric` - at least one numeric character * `special` - at least one special character (letters and digits excluded) * `all` - combination of `uppercase`, `lowercase`, `numeric` and `special`")
  ...
  public CharacterRules numberOfCharacteristicsToEnforce(Integer numberOfCharacteristicsToEnforce) {
   ...
   /**
   * Number of characteristics to enforce e.g. from &#x60;[\&quot;uppercase\&quot;, \&quot;lowercase\&quot;, \&quot;numeric\&quot;, \&quot;special\&quot;]&#x60; all 4 character sets can be enforced; but also only 2 of them (must be between 0 and 4)
   * @return numberOfCharacteristicsToEnforce
  **/
  @ApiModelProperty(value = "Number of characteristics to enforce e.g. from `[\"uppercase\", \"lowercase\", \"numeric\", \"special\"]` all 4 character sets can be enforced; but also only 2 of them (must be between 0 and 4)")
