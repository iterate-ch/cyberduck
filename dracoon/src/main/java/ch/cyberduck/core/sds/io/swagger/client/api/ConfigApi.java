...
public class ConfigApi {
  ...
  /**
   * Request algorithms
   * ### Description: Retrieve a list of available algorithms used for encryption.  ### Precondition: Authenticated user.  ### Postcondition: List of available algorithms is returned.  ### Further Information: None.
   * @return AlgorithmVersionInfoList
   * @throws ApiException if fails to make API call
   */
  public AlgorithmVersionInfoList requestAlgorithms() throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ClassificationPoliciesConfig requestClassificationPoliciesConfigInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description:   Returns a list of currently enabled product packages.  ### Precondition: Authenticated user  ### Postcondition: List of currently enabled Product Packages is returned.  ### Further Information: 
   * @return ProductPackageResponseList
   * @throws ApiException if fails to make API call
   */
  public ProductPackageResponseList requestCurrentProductPackages() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description: Retrieve a list of guest users policies.  ### Precondition: Authenticated user.  ### Postcondition: List of configured guest users policies is returned.  ### Further Information: None.
   * @return GuestUsersPoliciesConfig
   * @throws ApiException if fails to make API call
   */
  public GuestUsersPoliciesConfig requestGuestUsersPoliciesConfigInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description: Retrieve a list of configured notification channels.  ### Precondition: Authenticated user.  ### Postcondition: List of notification channels is returned.  ### Further Information: None.
   * @return NotificationChannelList
   * @throws ApiException if fails to make API call
   */
  public NotificationChannelList requestNotificationChannelsInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public PasswordPoliciesConfig requestPasswordPoliciesConfigInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description:   Returns a list of product packages.  ### Precondition: Authenticated user  ### Postcondition: List of Product Packages is returned.  ### Further Information: 
   * @return ProductPackageResponseList
   * @throws ApiException if fails to make API call
   */
  public ProductPackageResponseList requestProductPackages() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description: Retrieve all configured S3 tags.  ### Precondition: Authenticated user.  ### Postcondition: List of configured S3 tags is returned.  ### Further Information: An empty list is returned if no S3 tags are found / configured.
   * @return S3TagList
   * @throws ApiException if fails to make API call
   */
  public S3TagList requestS3TagsInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   */
  @Deprecated
  public ConfigOptionList requestSystemSettings() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * ### Description: Retrieve virus-protection policy.  ### Precondition: Authenticated user.  ### Postcondition: Virus-protection policy is returned.  ### Further Information: None.
   * @return VirusProtectionPoliciesConfig
   * @throws ApiException if fails to make API call
   */
  public VirusProtectionPoliciesConfig requestVirusProtectionPolicyConfigInfo() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
