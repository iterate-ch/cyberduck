...
public class ConfigApi {
  ...
  public ConfigOptionList getAuthSettings(String xSdsAuthToken) throws ApiException {
      return getAuthSettingsWithHttpInfo(xSdsAuthToken).getData();
  }
     ...
     */
    @Deprecated
    public ApiResponse<ConfigOptionList> getAuthSettingsWithHttpInfo(String xSdsAuthToken) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
    ...
    public void setAuthSettings(ConfigOptionList body, String xSdsAuthToken) throws ApiException {
        ...
        setAuthSettingsWithHttpInfo(body, xSdsAuthToken);
    }
     ...
     */
    @Deprecated
    public ApiResponse<Void> setAuthSettingsWithHttpInfo(ConfigOptionList body, String xSdsAuthToken) throws ApiException {
