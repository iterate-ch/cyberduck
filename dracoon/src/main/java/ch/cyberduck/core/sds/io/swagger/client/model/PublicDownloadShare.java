...
public class PublicDownloadShare {
  ...
  **/
   ...
   * @return size
  **/
  @ApiModelProperty(required = true, value = "File size or container size not compressed (Bytes)")
  public Long getSize() {
    return size;
  }
  ...
  **/
  ...
  public PublicDownloadShare createdAt(java.util.Date createdAt) {
  ...
  **/
  ...
  public PublicDownloadShare expireAt(java.util.Date expireAt) {
  ...
  **/
   ...
   * @return isEncrypted
  **/
  @ApiModelProperty(value = "True if file is end-to-end encrypted.")
   ...
   * @return fileKey
  **/
  @ApiModelProperty(value = "File Key object if file is end-to-end encrypted.")
  ...
  **/
  @ApiModelProperty(value = "Encrypted Private Key if file is end-to-end encrypted.")
