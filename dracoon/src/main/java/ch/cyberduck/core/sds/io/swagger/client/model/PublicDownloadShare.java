...
public class PublicDownloadShare {
  ...
  private Boolean hideDownload = null;
  ...
  **/
  @Schema(required = true, description = "Determines whether Download Share has a limit for amount of downloads")
  ...
  public PublicDownloadShare mediaType(String mediaType) {
   ...
   /**
   * * &#x60;application/zip&#x60; (for folders and rooms)  * actual file media type (for files only)
   * @return mediaType
  **/
  @Schema(required = true, description = "* `application/zip` (for folders and rooms)  * actual file media type (for files only)")
  ...
  **/
  ...
  public PublicDownloadShare virusProtectionInfo(VirusProtectionInfo virusProtectionInfo) {
  ...
  **/
  ...
  public PublicDownloadShare hideDownload(Boolean hideDownload) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.isProtected, publicDownloadShare.isProtected) &&
        ...
        Objects.equals(this.virusProtectionInfo, publicDownloadShare.virusProtectionInfo) &&
        Objects.equals(this.hideDownload, publicDownloadShare.hideDownload);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isProtected, fileName, size, limitReached, creatorName, createdAt, hasDownloadLimit, mediaType, name, creatorUsername, expireAt, notes, isEncrypted, fileKey, privateKeyContainer, virusProtectionInfo, hideDownload);
  }
