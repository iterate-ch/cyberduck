 ...
 * Node permissions
 */
@ApiModel(description = "Node permissions")
...
public class NodePermissions {
   ...
   * @return manage
  **/
  @ApiModelProperty(required = true, value = "User / Group may grant all of the above permissions to other users and groups independently, may update room metadata and create / update / delete subordinary rooms, has all permissions.")
