...
public class NodePermissions {
  ...
  public NodePermissions manage(Boolean manage) {
   ...
   /**
   * User/Group may grant all of the above permissions to other users and groups independently, may update room metadata and create/update/delete subrooms, has all of the above permissions
   * @return manage
  **/
  @ApiModelProperty(required = true, value = "User/Group may grant all of the above permissions to other users and groups independently, may update room metadata and create/update/delete subrooms, has all of the above permissions")
   ...
   * @return read
  **/
  @ApiModelProperty(required = true, value = "User/Group may see all rooms, files and folders in the room and download everything, copy files from this room")
   ...
   * @return create
  **/
  @ApiModelProperty(required = true, value = "User/Group may upload files, create folders and copy/move files to this room, overwriting is not possible")
   ...
   * @return change
  **/
  @ApiModelProperty(required = true, value = "User/Group may update meta data of nodes: rename files and folders, change classification, etc.")
   ...
   * @return delete
  **/
  @ApiModelProperty(required = true, value = "User/Group may overwrite and remove files/folders, move files from this room")
  ...
  **/
  @ApiModelProperty(required = true, value = "User/Group may create download shares for files and containers view all previously created download shares in this room")
  ...
  **/
  @ApiModelProperty(required = true, value = "User/Group may create upload shares for containers, view all previously created upload shares in this room")
  ...
  **/
  @ApiModelProperty(required = true, value = "User/Group may look up files/folders in the Recycle Bin")
  ...
  **/
  @ApiModelProperty(required = true, value = "User/Group may restore files/folders from Recycle Bin – Room permissions required")
  ...
  **/
  @ApiModelProperty(required = true, value = "User/Group may permanently remove files/folders from the Recycle Bin")
