...
public class SystemInfo {
  ...
  **/
  @Schema(required = true, description = "Defines if login fields should be hidden")
   ...
   * @return s3Hosts
  **/
  @Schema(required = true, description = "List of S3 Hosts for CSP header")
  ...
  **/
  @Schema(required = true, description = "Determines whether S3 direct upload is enforced or not")
   ...
   * @return useS3Storage
  **/
  @Schema(required = true, description = "Defines if S3 is used as storage backend")
   ...
   * @return authMethods
  **/
  @Schema(required = true, description = "Authentication methods:  * `sql`  * `active_directory`  * `openid`  use `authData` instead")
