...
public class DeletedNode {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, referenceId, parentId, parentPath, type, name, expireAt, accessedAt, isEncrypted, notes, size, classification, createdAt, createdBy, updatedAt, updatedBy, deletedAt, deletedBy);
  }
