...
public class UpdateCustomerRequest {
  ...
  **/
  ...
  public void setIsLocked(Boolean isLocked) {
     ...
     * @return lockStatus
     **/
    @ApiModelProperty(value = "`DEPRECATED`: Customer lock status: * `false` - unlocked * `true` - locked  Please use `isLocked` instead. All users of this customer will be blocked and can not login anymore. (default: `false`)")
