 ...
 */
@ApiModel(description = "Request model for updating a customer")
...
public class UpdateCustomerRequest {
  ...
  **/
   ...
   * @return quotaMax
  **/
  @ApiModelProperty(value = "Maximal disc space which can be allocated by customer in bytes. -1 for unlimited")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyName, customerContractType, quotaMax, userMax, isLocked, lockStatus, providerCustomerId, webhooksMax);
  }
