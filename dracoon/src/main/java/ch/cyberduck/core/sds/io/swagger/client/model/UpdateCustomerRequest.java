...
public class UpdateCustomerRequest {
  ...
  **/
   ...
   * @return lockStatus
  **/
  @Schema(description = "Customer lock status:  * `false` - unlocked  * `true` - locked    Please use `isLocked` instead.  All users of this customer will be blocked and can not login anymore.")
