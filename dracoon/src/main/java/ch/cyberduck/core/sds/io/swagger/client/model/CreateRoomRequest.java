...
public class CreateRoomRequest {
  ...
  **/
  ...
  public CreateRoomRequest hasRecycleBin(Boolean hasRecycleBin) {
   ...
   /**
   * Is recycle bin active (for rooms only)  Recycle bin is always on (disabling is not possible).
   * @return hasRecycleBin
  **/
  @Schema(description = "Is recycle bin active (for rooms only)  Recycle bin is always on (disabling is not possible).")
