...
public class BrandingServerInfo {
  ...
  **/
  @ApiModelProperty(value = "Branding server URL")
  ...
  **/
  @ApiModelProperty(required = true, value = "Branding server customer UUID")
  ...
  **/
  @ApiModelProperty(required = true, value = "UUID of Branding <b style='color: green;'>&nbsp;NEW</b>")
