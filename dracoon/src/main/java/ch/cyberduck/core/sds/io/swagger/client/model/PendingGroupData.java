...
public class PendingGroupData {
  ...
  public PendingGroupData id(Long id) {
   ...
   /**
    * DEPRECATEDUnique identifier for the group use &#x60;id&#x60; from &#x60;GroupInfo&#x60; instead  [Deprecated since version 4.11.0]
   * @return id
  **/
   @ApiModelProperty(required = true, value = "DEPRECATEDUnique identifier for the group use `id` from `GroupInfo` instead  [Deprecated since version 4.11.0]")
  public Long getId() {
    return id;
  }
  ...
  public PendingGroupData name(String name) {
   ...
   /**
    * DEPRECATEDGroup name use &#x60;name&#x60; from &#x60;GroupInfo&#x60; instead  [Deprecated since version 4.11.0]
   * @return name
  **/
   @ApiModelProperty(required = true, value = "DEPRECATEDGroup name use `name` from `GroupInfo` instead  [Deprecated since version 4.11.0]")
