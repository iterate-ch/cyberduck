...
public class AuthApi {
   ...
   * ## &amp;#9888; Deprecated since version 4.3.0  ### Functional Description:   Provides information about authentication options.  ### Precondition:  None.  ### Effects:  None.  ### &amp;#9432; Further Information: The server identifies the relevant customer by the passed HTTP header &#x60;Origin&#x60;.   Use this call to customize the login form.    ### Important:  The default language and authentication method are always provided as topmost entry.  ### DEPRECATED: Currently supported languages (with ISO 639-1 code): * German (de) * English (en) * Spanish (es) * French (fr)
  ...
  public AuthInitResources getAuthInitResources() throws ApiException {
      return getAuthInitResourcesWithHttpInfo().getData();
  }
     ...
     * ## &amp;#9888; Deprecated since version 4.3.0  ### Functional Description:   Provides information about authentication options.  ### Precondition:  None.  ### Effects:  None.  ### &amp;#9432; Further Information: The server identifies the relevant customer by the passed HTTP header &#x60;Origin&#x60;.   Use this call to customize the login form.    ### Important:  The default language and authentication method are always provided as topmost entry.  ### DEPRECATED: Currently supported languages (with ISO 639-1 code): * German (de) * English (en) * Spanish (es) * French (fr)
     *
     * @return ApiResponse&lt;AuthInitResources&gt;
     * @throws ApiException if fails to make API call
     * @deprecated
     */
    @Deprecated
    public ApiResponse<AuthInitResources> getAuthInitResourcesWithHttpInfo() throws ApiException {
        Object localVarPostBody = null;
