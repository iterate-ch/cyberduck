...
public class UserApi {
  ...
  public void deleteOAuthAuthorization(String xSdsAuthToken, String clientId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/user/oauth/authorizations/{client_id}"
