...
public class Webhook {
  ...
  **/
   ...
   * @return expireAt
  **/
  @ApiModelProperty(required = true, value = "Expiration date / time")
  ...
  **/
   ...
   * @return failStatus
  **/
  @ApiModelProperty(value = "Last HTTP status code when a webhook is disabled due to delivery failures")
