...
public class RoleUser {
  ...
  **/
  ...
  public RoleUser id(Long id) {
   ...
   /**
   * Unique identifier for the user  use &#x60;id&#x60; from &#x60;UserInfo&#x60; instead
   * @return id
  **/
  @Schema(required = true, description = "Unique identifier for the user  use `id` from `UserInfo` instead")
  public Long getId() {
    return id;
  }
