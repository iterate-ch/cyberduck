...
public class SyslogApi {
   ...
   */
  @Deprecated
  public List<AuditNodeResponse> getAuditNodeUserData1(String xSdsAuthToken, String xSdsDateFormat, String filter, String sort) throws ApiException {
      return getAuditNodeUserData1WithHttpInfo(xSdsAuthToken, xSdsDateFormat, filter, sort).getData();
  }
     ...
     */
    @Deprecated
    public ApiResponse<List<AuditNodeResponse>> getAuditNodeUserData1WithHttpInfo(String xSdsAuthToken, String xSdsDateFormat, String filter, String sort) throws ApiException {
