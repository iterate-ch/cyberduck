...
public class SyslogApi {
  ...
  public List<AuditNodeResponse> getAuditNodeUserData(String xSdsAuthToken, String xSdsDateFormat, String filter, String sort) throws ApiException {
    ...
    String localVarPath = "/syslog/audits/nodes";
...
if (xSdsDateFormat != null)
   ...
   * &lt;div class&#x3D;\&quot;sds\&quot;&gt;&lt;p&gt;&lt;b style&#x3D;&#39;color: red;&#39;&gt;DEPRECATED&lt;/b&gt;&lt;br&gt;&lt;span&gt;Please use /eventlog/operations API &lt;/span&gt;&lt;p&gt;&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Functional Description:&lt;/strong&gt; &lt;br/&gt;Retrieve syslog (&#x3D; audit log) operation IDs and the associated Log Operation Description.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Precondition:&lt;/strong&gt; Role Log Auditor required.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Effects:&lt;/strong&gt; None.&lt;/p&gt;&lt;p&gt;&lt;strong&gt;Further Information:&lt;/strong&gt; None.&lt;/p&gt;&lt;/div&gt;
   * @param xSdsAuthToken Authentication token (required)
  ...
  public LogOperationList getLogOperations(String xSdsAuthToken) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/syslog/operations";
  ...
  public SyslogEventList getSyslogEvents(String xSdsAuthToken, String xSdsDateFormat, Integer offset, Integer limit, LocalDate dateStart, LocalDate dateEnd, List<Integer> type, List<Integer> userId, List<Integer> status, List<String> userClient) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/syslog/events";
