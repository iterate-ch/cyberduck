...
public class SyslogApi {
   ...
   */
  @Deprecated
  public List<AuditNodeResponse> getAuditNodeUserData1(String xSdsAuthToken, String xSdsDateFormat, String filter, Integer limit, Integer offset, String sort) throws ApiException {
    return getAuditNodeUserData1WithHttpInfo(xSdsAuthToken, xSdsDateFormat, filter, limit, offset, sort).getData();
      }
   ...
   */
  @Deprecated
  public ApiResponse<List<AuditNodeResponse>> getAuditNodeUserData1WithHttpInfo(String xSdsAuthToken, String xSdsDateFormat, String filter, Integer limit, Integer offset, String sort) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/v4/syslog/audits/nodes";
...
if (xSdsDateFormat != null)
   ...
   */
  @Deprecated
  public LogOperationList getLogOperations1(String xSdsAuthToken, Boolean isDeprecated) throws ApiException {
    return getLogOperations1WithHttpInfo(xSdsAuthToken, isDeprecated).getData();
      }
   ...
   */
  @Deprecated
  public ApiResponse<LogOperationList> getLogOperations1WithHttpInfo(String xSdsAuthToken, Boolean isDeprecated) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/v4/syslog/operations";
   ...
   */
  @Deprecated
  public SyslogEventList getSyslogEvents(String xSdsAuthToken, String xSdsDateFormat, String dateEnd, String dateStart, Integer limit, Integer offset, String sort, Integer status, Integer type, String userClient, Long userId) throws ApiException {
    return getSyslogEventsWithHttpInfo(xSdsAuthToken, xSdsDateFormat, dateEnd, dateStart, limit, offset, sort, status, type, userClient, userId).getData();
      }
   ...
   */
  @Deprecated
  public ApiResponse<SyslogEventList> getSyslogEventsWithHttpInfo(String xSdsAuthToken, String xSdsDateFormat, String dateEnd, String dateStart, Integer limit, Integer offset, String sort, Integer status, Integer type, String userClient, Long userId) throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/v4/syslog/events";
