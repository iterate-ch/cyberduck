...
public class SyslogApi {
   ...
   */
  public List<AuditNodeResponse> getAuditNodeUserData1(String filter, String sort, String xSdsAuthToken, String xSdsDateFormat) throws ApiException {
...
if (xSdsDateFormat != null)
   ...
   * @throws ApiException if fails to make API call
   */
  public LogOperationList getLogOperations1(Boolean isDeprecated, String xSdsAuthToken) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public SyslogEventList getSyslogEvents(Integer offset, Integer limit, String dateStart, String dateEnd, Integer type, Long userId, Integer status, String userClient, String xSdsAuthToken, String xSdsDateFormat) throws ApiException {
    Object localVarPostBody = null;
