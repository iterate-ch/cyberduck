...
public class SystemPoliciesConfigApi {
  ...
  /**
   * Change MFA policies for internal/external users
   * ### Description: Change current multi-factor authentication policies for all users of specific user type.    ### Precondition: Right &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; change global config&lt;/span&gt; and role &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128100; Config Manager&lt;/span&gt; of the Provider Customer required.  ### Postcondition: Multi-factor authentication policies are changed for all users of specific user type.    ### Further Information: None.
   * @param body  (required)
   * @param userType User type (required)
   * @return MfaPoliciesConfig
   * @throws ApiException if fails to make API call
   */
  public MfaPoliciesConfig changeMfaPoliciesConfigUserType(UpdateMfaPoliciesConfig body, String userType) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling changeMfaPoliciesConfigUserType");
    }
    // verify the required parameter 'userType' is set
    if (userType == null) {
      throw new ApiException(400, "Missing the required parameter 'userType' when calling changeMfaPoliciesConfigUserType");
    }
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/mfa/{user_type}"
      .replaceAll("\\{" + "user_type" + "\\}", apiClient.escapeString(userType.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public ClassificationPoliciesConfig requestClassificationPoliciesConfig() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/classifications";
   ...
   * ### Description:   Retrieve guest user policies.    ### Precondition: Right &lt;span style&#x3D;&#x27;padding: 3px; background-color: #F6F7F8; border: 1px solid #000; border-radius: 5px; display: inline;&#x27;&gt;&amp;#128275; read global config&lt;/span&gt; of the Provider Customer required.  ### Postcondition: Guest user policies are returned.  ### Further Information: None.
   * @return GuestUsersPoliciesConfig
   * @throws ApiException if fails to make API call
   */
  public GuestUsersPoliciesConfig requestGuestUsersPoliciesConfig() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/guest_users";
   ...
   * @throws ApiException if fails to make API call
   */
  public MfaPoliciesConfig requestMfaPoliciesConfig() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/mfa";
   ...
   * @throws ApiException if fails to make API call
   */
  public PasswordPoliciesConfig requestPasswordPoliciesConfig() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/passwords";
   ...
   * @throws ApiException if fails to make API call
   */
  public PasswordPoliciesConfig requestPasswordPoliciesForPasswordType(String passwordType) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public VirusProtectionPoliciesConfig requestVirusProtectionPoliciesConfig() throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/v4/system/config/policies/virus_protection";
