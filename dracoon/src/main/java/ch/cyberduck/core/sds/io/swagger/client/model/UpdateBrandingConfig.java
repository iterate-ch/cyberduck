...
/**
 * DEPRECATED Request model for updating branding settings
 */
@ApiModel(description = "DEPRECATED Request model for updating branding settings")
...
public class UpdateBrandingConfig {
  ...
  **/
   @ApiModelProperty(value = "Set `true` to reset `brandingProviderUrl`.")
  ...
  **/
   @ApiModelProperty(value = "Set `true` to reset `brandingQualifier`.")
