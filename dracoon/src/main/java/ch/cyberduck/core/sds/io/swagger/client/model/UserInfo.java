...
public class UserInfo {
  ...
  /**
   * User type:  * &#x60;internal&#x60; - ordinary DRACOON user  * &#x60;external&#x60; - external user without DRACOON account  * &#x60;system&#x60; - system user (non human &amp;#128125;)  * &#x60;deleted&#x60; - deleted DRACOON user
   */
  ...
  **/
   ...
   * @return userType
  **/
  @Schema(required = true, description = "User type:  * `internal` - ordinary DRACOON user  * `external` - external user without DRACOON account  * `system` - system user (non human &#128125;)  * `deleted` - deleted DRACOON user")
  ...
  **/
   ...
   * @return userName
  **/
  @Schema(required = true, description = "Username (only returned for `internal` users)")
   ...
   * @return firstName
  **/
  @Schema(required = true, description = "User first name (mandatory if `userType` is `internal`)")
   ...
   * @return lastName
  **/
  @Schema(required = true, description = "User last name (mandatory if `userType` is `internal`)")
  ...
  **/
  ...
  public UserInfo displayName(String displayName) {
   ...
   /**
   * Display name  use other fields from &#x60;UserInfo&#x60; instead to combine a display name
   * @return displayName
  **/
  @Schema(description = "Display name  use other fields from `UserInfo` instead to combine a display name")
