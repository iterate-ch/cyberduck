...
public class UserInfo {
  ...
  **/
  ...
  public UserInfo displayName(String displayName) {
    ...
    /**
     * DEPRECATEDDisplay name use other fields from &#x60;UserInfo&#x60; instead to combine a display name  [Deprecated since version 4.11.0]
     * @return displayName
     **/
    @ApiModelProperty(required = true, value = "DEPRECATEDDisplay name use other fields from `UserInfo` instead to combine a display name  [Deprecated since version 4.11.0]")
  public String getDisplayName() {
    ...
    /**
     * Email (not used)  [Since version 4.11.0]
     *
     * @return email
     **/
    @ApiModelProperty(value = "Email (not used)  [Since version 4.11.0]")
    ...
    /**
     * Job title  [Since version 4.11.0]
     *
     * @return title
     **/
    @ApiModelProperty(value = "Job title  [Since version 4.11.0]")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userType, avatarUuid, displayName, firstName, lastName, email, title);
  }
