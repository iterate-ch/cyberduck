...
public class UpdateCustomerResponse {
  ...
  **/
  ...
  public UpdateCustomerResponse lockStatus(Boolean lockStatus) {
   ...
   /**
    * &#x60;DEPRECATED&#x60;: Customer lock status: * &#x60;false&#x60; - unlocked * &#x60;true&#x60; - locked  Please use &#x60;isLocked&#x60; instead. All users of this customer will be blocked and can not login anymore. (default: &#x60;false&#x60;)  [Deprecated since version 4.7.0]
   * @return lockStatus
  **/
   @ApiModelProperty(required = true, value = "`DEPRECATED`: Customer lock status: * `false` - unlocked * `true` - locked  Please use `isLocked` instead. All users of this customer will be blocked and can not login anymore. (default: `false`)  [Deprecated since version 4.7.0]")
   ...
   * @return isLocked
  **/
   @ApiModelProperty(value = "Customer is locked: * `false` - unlocked * `true` - locked  All users of this customer will be blocked and can not login anymore. (default: `false`)")
