...
public class UpdateCustomerResponse {
  ...
  **/
   ...
   * @return customerUuid
  **/
  @Schema(required = true, description = "Customer UUID")
  ...
  **/
   ...
   * @return webhooksMax
  **/
  @Schema(description = "Maximal number of webhooks")
  ...
  **/
  @Schema(description = "Customer activation code string:  * valid only for types `free` and `demo`  * for `pay` customers it is empty")
  ...
  public UpdateCustomerResponse lockStatus(Boolean lockStatus) {
   ...
   /**
   * Customer lock status:  * &#x60;false&#x60; - unlocked  * &#x60;true&#x60; - locked    Please use &#x60;isLocked&#x60; instead.  All users of this customer will be blocked and can not login anymore.
   * @return lockStatus
  **/
  @Schema(required = true, description = "Customer lock status:  * `false` - unlocked  * `true` - locked    Please use `isLocked` instead.  All users of this customer will be blocked and can not login anymore.")
