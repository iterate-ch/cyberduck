...
public class UpdateOpenIdIdpConfigRequest {
  ...
  @JsonProperty("useAuthProxyEnabled")
  private Boolean useAuthProxyEnabled = false;
  ...
  **/
  ...
  public UpdateOpenIdIdpConfigRequest isEnabled(Boolean isEnabled) {
  ...
  **/
   ...
   * @return flow
  **/
  @Schema(description = "Flow, which is used at authentication")
  ...
  **/
  @Schema(description = "Source, which is used to get user information at the import or update of a user.")
  ...
  **/
  ...
  public UpdateOpenIdIdpConfigRequest useAuthProxyEnabled(Boolean useAuthProxyEnabled) {
    this.useAuthProxyEnabled = useAuthProxyEnabled;
    return this;
  }

   /**
   * Determines if the IDP use the DRACOON Auth Proxy.  For OpenID Connect, the scopes &#x60;email&#x60; and &#x60;profile&#x60; are needed.
   * @return useAuthProxyEnabled
  **/
  @Schema(description = "Determines if the IDP use the DRACOON Auth Proxy.  For OpenID Connect, the scopes `email` and `profile` are needed.")
  public Boolean isUseAuthProxyEnabled() {
    return useAuthProxyEnabled;
  }

  public void setUseAuthProxyEnabled(Boolean useAuthProxyEnabled) {
    this.useAuthProxyEnabled = useAuthProxyEnabled;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, updateOpenIdIdpConfigRequest.name) &&
        Objects.equals(this.isEnabled, updateOpenIdIdpConfigRequest.isEnabled) &&
  ...
  public String toString() {
    ...
    sb.append("    useAuthProxyEnabled: ").append(toIndentedString(useAuthProxyEnabled)).append("\n");
    sb.append("}");
    return sb.toString();
  }
