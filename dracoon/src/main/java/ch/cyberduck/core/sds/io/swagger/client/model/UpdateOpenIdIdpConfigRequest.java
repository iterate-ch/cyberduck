 ...
 */
@ApiModel(description = "Request model for updating an OpenID Connect IDP configuration")
...
public class UpdateOpenIdIdpConfigRequest {
  ...
  **/
   ...
   * @return clientId
  **/
  @ApiModelProperty(value = "ID of the OpenID client")
  ...
  **/
  @ApiModelProperty(value = "Set `true` to reset `fallbackMappingClaim`.")
