...
public class ActiveDirectoryConfig {
  ...
  **/
  ...
  public ActiveDirectoryConfig homeFolderParent(Long homeFolderParent) {
   ...
   /**
   * DEPRECATED, will be ignored ID of the room in which the individual rooms for users will be created.  [Deprecated since version 4.10.0]
   * @return homeFolderParent
  **/
  @ApiModelProperty(value = "DEPRECATED, will be ignored ID of the room in which the individual rooms for users will be created.  [Deprecated since version 4.10.0]")
  ...
  public ActiveDirectoryConfig createHomeFolder(Boolean createHomeFolder) {
   ...
   /**
   * DEPRECATED, will be ignored Determines whether a room is created for each user that is created by automatic import (like a home folder). Room&#39;s name will equal the user&#39;s login name. (default: &#x60;false&#x60;)  [Deprecated since version 4.10.0]
   * @return createHomeFolder
  **/
  @ApiModelProperty(value = "DEPRECATED, will be ignored Determines whether a room is created for each user that is created by automatic import (like a home folder). Room's name will equal the user's login name. (default: `false`)  [Deprecated since version 4.10.0]")
