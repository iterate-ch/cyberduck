...
public class CreateDownloadShareRequest {
  ...
  **/
  ...
  public CreateDownloadShareRequest hideDownload(Boolean hideDownload) {
    this.hideDownload = hideDownload;
    return this;
  }

   /**
   * Whether or not the download is hidden on a public download share
   * @return hideDownload
  **/
  @Schema(description = "Whether or not the download is hidden on a public download share")
  ...
  **/
  @Schema(description = "Notify creator on every download.")
  ...
  **/
  @Schema(description = "Language tag for messages to creator")
  ...
  public CreateDownloadShareRequest sendMail(Boolean sendMail) {
   ...
   /**
   * Notify recipients via email  Please use &#x60;POST /shares/downloads/{share_id}/email&#x60; API instead.
   * @return sendMail
  **/
  @Schema(description = "Notify recipients via email  Please use `POST /shares/downloads/{share_id}/email` API instead.")
  ...
  **/
  @Schema(description = "CSV string of recipient email addresses")
   ...
   * @return mailSubject
  **/
  @Schema(description = "Notification email subject")
   ...
   * @return mailBody
  **/
  @Schema(description = "Notification email content")
  ...
  public CreateDownloadShareRequest sendSms(Boolean sendSms) {
   ...
   /**
   * Send share password via SMS  Please use &#x60;textMessageRecipients&#x60; attribute instead.
   * @return sendSms
  **/
  @Schema(description = "Send share password via SMS  Please use `textMessageRecipients` attribute instead.")
  ...
  **/
  @Schema(description = "CSV string of recipient MSISDNs")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.nodeId, createDownloadShareRequest.nodeId) &&
        ...
        Objects.equals(this.hideDownload, createDownloadShareRequest.hideDownload) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nodeId, name, password, expiration, notes, internalNotes, showCreatorName, showCreatorUsername, maxDownloads, keyPair, fileKey, receiverLanguage, textMessageRecipients, hideDownload, notifyCreator, creatorLanguage, sendMail, mailRecipients, mailSubject, mailBody, sendSms, smsRecipients);
  }
  ...
  public String toString() {
    ...
    sb.append("    hideDownload: ").append(toIndentedString(hideDownload)).append("\n");
