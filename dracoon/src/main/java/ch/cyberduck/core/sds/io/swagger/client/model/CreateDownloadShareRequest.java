...
public class CreateDownloadShareRequest {
  ...
  **/
   ...
   * @return expiration
  **/
  @ApiModelProperty(value = "Download share expiration.")
  ...
  **/
   ...
   * @return keyPair
  **/
  @ApiModelProperty(value = "Key Pair; mandatory for encrypted shares <b style='color: green;'>&nbsp;NEW</b>")
   ...
   * @return fileKey
  **/
  @ApiModelProperty(value = "Encrypted File Key; mandatory for encrypted shares <b style='color: green;'>&nbsp;NEW</b>")
