...
public class EventlogApi {
   ...
   */
  public AuditNodeInfoResponse requestAuditNodeInfo(Long parentId, Integer offset, Integer limit, String filter, String sort) throws ApiException {
   ...
   */
  @Deprecated
  public List<AuditNodeResponse> requestAuditNodeUserData(String xSdsDateFormat, Integer offset, Integer limit, String filter, String sort) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public LogEventList requestLogEventsAsJson(String xSdsDateFormat, String sort, Integer offset, Integer limit, String dateStart, String dateEnd, Integer type, Long userId, String status, String userClient) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public LogOperationList requestLogOperations(Boolean isDeprecated) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
