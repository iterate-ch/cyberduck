...
public class EventlogApi {
  ...
  public List<AuditNodeResponse> getAuditNodeUserData(String xSdsAuthToken, String xSdsDateFormat, String filter, String sort) throws ApiException {
      return getAuditNodeUserDataWithHttpInfo(xSdsAuthToken, xSdsDateFormat, filter, sort).getData();
  }
     ...
     * @throws ApiException if fails to make API call
     */
    public ApiResponse<List<AuditNodeResponse>> getAuditNodeUserDataWithHttpInfo(String xSdsAuthToken, String xSdsDateFormat, String filter, String sort) throws ApiException {
