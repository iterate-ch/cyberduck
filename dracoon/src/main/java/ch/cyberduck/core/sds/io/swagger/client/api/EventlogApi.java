...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-08-20T10:17:39.204928+02:00[Europe/Zurich]")public class EventlogApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public LogEventList requestLogEventsAsCsv1(String xSdsDateFormat, String sort, Integer offset, Integer limit, String dateStart, String dateEnd, Integer type, Long userId, String status, String userClient, String xSdsAuthToken, String xSdsAuthToken) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
