 ...
 */
@ApiModel(description = "Request model for creating an Active Directory configuration")
...
public class CreateActiveDirectoryConfigRequest {
  ...
  **/
  ...
  public CreateActiveDirectoryConfigRequest useLdaps(Boolean useLdaps) {
   ...
   /**
   * Determines whether LDAPS should be used instead of plain LDAP. (default: &#x60;false&#x60;)
   * @return useLdaps
  **/
  @ApiModelProperty(value = "Determines whether LDAPS should be used instead of plain LDAP. (default: `false`)")
