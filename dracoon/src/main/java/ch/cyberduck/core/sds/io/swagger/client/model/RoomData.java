...
public class RoomData {
  ...
  **/
  @Schema(required = true, description = "Is recycle bin active (for rooms only)  Recycle bin is always on (disabling is not possible).")
   ...
   * @return children
  **/
  @Schema(description = "List of rooms, where this room is a parent (if exist)")
