...
public class RoomData {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, id, isGranted, name, isEncrypted, recycleBinRetentionPeriod, parentId, size, permissions, createdAt, createdBy, updatedAt, updatedBy, quota, cntDownloadShares, cntUploadShares, isFavorite, hasRecycleBin, children, cntAdmins, cntUsers);
  }
