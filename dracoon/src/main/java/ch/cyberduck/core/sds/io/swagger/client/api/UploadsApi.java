...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-08-31T11:26:27.086143+02:00[Europe/Zurich]")public class UploadsApi {
   ...
   * @param body The body must be empty if public upload token is used.
...
The &#x60;resolutionStrategy&#x60; in that case will be always &#x60;autorename&#x60; (required)
  ...
  public Node completeFileUploadByToken(CompleteUploadRequest body, String token) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling completeFileUploadByToken");
    }
    // verify the required parameter 'token' is set
    if (token == null) {
