 ...
 */
@ApiModel(description = "User Authentication Data Update Request")
...
public class UserAuthDataUpdateRequest {
   ...
   * @return method
  **/
  @ApiModelProperty(value = "Authentication method  Authentication methods: * `basic` (or `sql`) * `active_directory` * `radius` * `openid`")
