...
public class UserAuthData {
   ...
   * @return method
  **/
  @Schema(required = true, description = "Authentication method    Authentication methods:  * `basic`  * `active_directory`  * `openid`")
  ...
  **/
   ...
   * @return password
  **/
  @Schema(description = "Password (only relevant for `basic` authentication type)  *NOT* your Active Directory, OpenID password!")
  ...
  **/
  @Schema(description = "Determines whether user has to change his / her password  * default: `true` for `basic` auth type  * default: `false` for `active_directory`, `openid` auth types")
