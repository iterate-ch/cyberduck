 ...
 */
@ApiModel(description = "Node information (Node can be a room, folder or file)")
...
public class Node {
  ...
  **/
  @ApiModelProperty(example = "2", value = "Classification ID: * `1` - public * `2` - internal * `3` - confidential * `4` - strictly confidential")
  ...
  **/
   ...
   * @return cntComments
  **/
  @ApiModelProperty(value = "Returns the number of comments of this node.")
  ...
  **/
   ...
   * @return isBrowsable
  **/
  @ApiModelProperty(value = "Determines whether node is browsable by client (for rooms only)  [Since version 4.11.0]")
  ...
  public Node cntRooms(Integer cntRooms) {
   ...
   /**
   * Amount of direct child rooms where this node is the parent node (no recursion; for rooms only)  [Since version 4.11.0]
   * @return cntRooms
  **/
  @ApiModelProperty(value = "Amount of direct child rooms where this node is the parent node (no recursion; for rooms only)  [Since version 4.11.0]")
  ...
  public Node cntFolders(Integer cntFolders) {
   ...
   /**
   * Amount of direct child folders where this node is the parent node (no recursion; for rooms / folders only)  [Since version 4.11.0]
   * @return cntFolders
  **/
  @ApiModelProperty(value = "Amount of direct child folders where this node is the parent node (no recursion; for rooms / folders only)  [Since version 4.11.0]")
  ...
  public Node cntFiles(Integer cntFiles) {
   ...
   /**
   * Amount of direct child files where this node is the parent node (no recursion; for rooms / folders only)  [Since version 4.11.0]
   * @return cntFiles
  **/
  @ApiModelProperty(value = "Amount of direct child files where this node is the parent node (no recursion; for rooms / folders only)  [Since version 4.11.0]")
   ...
   * @return authParentId
  **/
  @ApiModelProperty(value = "Auth parent room ID  [Since version 4.15.0]")
  ...
  public Node cntChildren(Integer cntChildren) {
   ...
   /**
   * Number of direct children (no recursion; for rooms / folders only)  [Deprecated since version 4.11.0]
   * @return cntChildren
  **/
  @ApiModelProperty(value = "Number of direct children (no recursion; for rooms / folders only)  [Deprecated since version 4.11.0]")
  ...
  **/
  ...
  public Node addChildrenItem(Node childrenItem) {
   ...
   /**
   * &#x60;DEPRECATED&#x60;: Child nodes list (if requested) (for rooms / folders only)  [Deprecated since version 4.10.0]
   * @return children
  **/
  @ApiModelProperty(value = "`DEPRECATED`: Child nodes list (if requested) (for rooms / folders only)  [Deprecated since version 4.10.0]")
