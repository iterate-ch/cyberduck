...
public class Node {
  ...
  private ch.cyberduck.core.sds.model.EncryptionInfo encryptionInfo = null;
  ...
  **/
  ...
  public Node createdAt(java.util.Date createdAt) {
  ...
  **/
  ...
  public Node updatedAt(java.util.Date updatedAt) {
  ...
  **/
  ...
  public Node expireAt(java.util.Date expireAt) {
  ...
  **/
   ...
   * @return fileType
  **/
  @ApiModelProperty(value = "For files only: File type (extension)")
   ...
   * @return mediaType
  **/
  @ApiModelProperty(value = "For files only: File media type.")
  ...
  public Node cntAdmins(Integer cntAdmins) {
   ...
   /**
   * &lt;b style&#x3D;&#39;color: red;&#39;&gt; DEPRECATED&lt;/b&gt; For rooms only: Number of admins
   * @return cntAdmins
  **/
  @ApiModelProperty(value = "<b style='color: red;'> DEPRECATED</b> For rooms only: Number of admins")
  ...
  public Node cntUsers(Integer cntUsers) {
   ...
   /**
   * &lt;b style&#x3D;&#39;color: red;&#39;&gt; DEPRECATED&lt;/b&gt; For rooms only: Number of users
   * @return cntUsers
  **/
  @ApiModelProperty(value = "<b style='color: red;'> DEPRECATED</b> For rooms only: Number of users")
  ...
  **/
  @ApiModelProperty(value = "For files only: Classification ID, the string description will be provided with resources")
  ...
  **/
   ...
   * @return permissions
  **/
  @ApiModelProperty(value = "User permissions: Aggregated user permissions (all group and directly granted permissions)")
  ...
  **/
   ...
   * @return cntChildren
  **/
  @ApiModelProperty(value = "For rooms/folders only: Number of direct children (no recursion)")
  ...
  **/
  @ApiModelProperty(value = "For files/folders only: Number of deleted versions of this file/folder")
  ...
  **/
  @ApiModelProperty(value = "For rooms only: Is Recycle Bin active")
  ...
  **/
   ...
   * @return isFavorite
  **/
  @ApiModelProperty(value = "Node is marked as favorite")
  ...
  **/
  @ApiModelProperty(value = "Is inherit active. Only for Nodes with type 'room'")
  ...
  public Node encryptionInfo(ch.cyberduck.core.sds.model.EncryptionInfo encryptionInfo) {
  ...
  **/
  @ApiModelProperty(value = "encryption info")
  public ch.cyberduck.core.sds.model.EncryptionInfo getEncryptionInfo() {
    return encryptionInfo;
  }

  public void setEncryptionInfo(ch.cyberduck.core.sds.model.EncryptionInfo encryptionInfo) {
    this.encryptionInfo = encryptionInfo;
  }
  ...
  **/
   ...
   * @return children
  **/
  @ApiModelProperty(value = "For rooms and folders: child nodes list (if requested)")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, parentId, parentPath, createdAt, createdBy, updatedAt, updatedBy, expireAt, name, hash, fileType, mediaType, cntAdmins, cntUsers, size, classification, notes, permissions, isEncrypted, cntChildren, cntDeletedVersions, hasRecycleBin, recycleBinRetentionPeriod, quota, cntDownloadShares, cntUploadShares, isFavorite, inheritPermissions, encryptionInfo, branchVersion, mediaToken, children);
  }
