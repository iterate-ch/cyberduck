...
public class Node {
  ...
  **/
   ...
   * @return referenceId
  **/
  @Schema(description = "Reference ID. Identical across all versions of a file")
  ...
  **/
  @Schema(description = "Time the node was created on external file system")
  ...
  **/
  @Schema(description = "Time the content of a node was last modified on external file system")
  ...
  **/
  ...
  public Node isSubscribed(Boolean isSubscribed) {
   ...
   * @return isSubscribed
  **/
  @Schema(description = "Node is subscribed")
  ...
  **/
   ...
   * @return isBrowsable
  **/
  @Schema(description = "Determines whether node is browsable by client (for rooms only)")
  ...
  public Node cntRooms(Integer cntRooms) {
   ...
   /**
   * Amount of direct child rooms where this node is the parent node  (no recursion; for rooms only)
   * @return cntRooms
  **/
  @Schema(description = "Amount of direct child rooms where this node is the parent node  (no recursion; for rooms only)")
  ...
  public Node cntFolders(Integer cntFolders) {
   ...
   /**
   * Amount of direct child folders where this node is the parent node  (no recursion; for rooms / folders only)
   * @return cntFolders
  **/
  @Schema(description = "Amount of direct child folders where this node is the parent node  (no recursion; for rooms / folders only)")
  ...
  public Node cntFiles(Integer cntFiles) {
   ...
   /**
   * Amount of direct child files where this node is the parent node  (no recursion; for rooms / folders only)
   * @return cntFiles
  **/
  @Schema(description = "Amount of direct child files where this node is the parent node  (no recursion; for rooms / folders only)")
  ...
  **/
   ...
   * @return cntChildren
  **/
  @Schema(description = "Number of direct children  (no recursion; for rooms / folders only)")
   ...
   * @return children
  **/
  @Schema(description = "Child nodes list (if requested)  (for rooms / folders only)")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, node.id) &&
        ...
        Objects.equals(this.isSubscribed, node.isSubscribed) &&
