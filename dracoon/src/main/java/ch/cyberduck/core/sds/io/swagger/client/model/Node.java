...
public class Node {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, name, parentId, parentPath, createdAt, createdBy, updatedAt, updatedBy, expireAt, hash, fileType, mediaType, size, classification, notes, permissions, inheritPermissions, isEncrypted, encryptionInfo, cntChildren, cntDeletedVersions, cntComments, cntDownloadShares, cntUploadShares, recycleBinRetentionPeriod, hasActivitiesLog, quota, isFavorite, branchVersion, mediaToken, hasRecycleBin, children, cntAdmins, cntUsers);
  }
