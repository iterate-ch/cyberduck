...
public class OcisUploadFeatureTest extends AbstractOcisTest {
    ...
    public void testUploadLargeFileInChunks() throws Exception {
        ...
        final Local local = new Local(System.getProperty("java.io.tmpdir"), name);
        {
            ...
            final Void response = feature.upload(new TusWriteFeature(session, capabilities), file, local, new BandwidthThrottle(BandwidthThrottle.UNLIMITED), ProgressListener.noop, count, status, ConnectionCallback.noop);
