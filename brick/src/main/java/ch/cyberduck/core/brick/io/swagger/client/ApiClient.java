...
import ch.cyberduck.core.brick.io.swagger.client.auth.Authentication;
import ch.cyberduck.core.brick.io.swagger.client.auth.HttpBasicAuth;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-25T22:25:43.390877+02:00[Europe/Paris]")public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("api_key", new ApiKeyAuth("header", "X-FilesAPI-Key"));
