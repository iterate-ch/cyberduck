...
import ch.cyberduck.core.brick.io.swagger.client.model.PublicKeysBody;
import ch.cyberduck.core.brick.io.swagger.client.model.PublicKeysIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-12T12:23:43.971535+02:00[Europe/Paris]")public class PublicKeysApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicKeyEntity patchPublicKeysId(PublicKeysIdBody body, Integer id) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling patchPublicKeysId");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public PublicKeyEntity postPublicKeys(PublicKeysBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling postPublicKeys");
    }
    // create path and map variables
    String localVarPath = "/public_keys";
