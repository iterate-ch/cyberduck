 ...
 * List Automations
 */
@ApiModel(description = "List Automations")
...
public class AutomationEntity {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "Automation ID")
   ...
   * @return automation
  **/
  @ApiModelProperty(example = "create_folder", value = "Automation type")
   ...
   * @return trigger
  **/
  @ApiModelProperty(example = "realtime", value = "How this automation is triggered to run. One of: `realtime`, `daily`, `custom_schedule`, `webhook`, `email`, or `action`.")
   ...
   * @return interval
  **/
  @ApiModelProperty(example = "week", value = "If trigger is `daily`, this specifies how often to run this automation.  One of: `day`, `week`, `week_end`, `month`, `month_end`, `quarter`, `quarter_end`, `year`, `year_end`")
  ...
  **/
  @ApiModelProperty(example = "2020-01-01", value = "If trigger is `daily`, date this automation will next run.")
   ...
   * @return schedule
  **/
  @ApiModelProperty(example = "{\"days_of_week\":[0,2,4],\"times_of_day\":[\"6:30\",\"14:30\"],\"time_zone\":\"Eastern Time (US & Canada)\"}", value = "If trigger is `custom_schedule`, Custom schedule description for when the automation should be run.")
   ...
   * @return source
  **/
  @ApiModelProperty(example = "", value = "Source Path")
   ...
   * @return destinations
  **/
  @ApiModelProperty(example = "", value = "Destination Path")
  ...
  **/
  @ApiModelProperty(example = "", value = "If set, this string in the destination path will be replaced with the value in `destination_replace_to`.")
  ...
  **/
  @ApiModelProperty(example = "", value = "If set, this string will replace the value `destination_replace_from` in the destination filename. You can use special patterns here.")
   ...
   * @return path
  **/
  @ApiModelProperty(example = "", value = "Path on which this Automation runs.  Supports globs.")
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "1", value = "User ID of the Automation's creator.")
   ...
   * @return userIds
  **/
  @ApiModelProperty(example = "[1,2]", value = "IDs of Users for the Automation (i.e. who to Request File from)")
   ...
   * @return groupIds
  **/
  @ApiModelProperty(example = "[1,2]", value = "IDs of Groups for the Automation (i.e. who to Request File from)")
   ...
   * @return webhookUrl
  **/
  @ApiModelProperty(example = "https://app.files.com/api/webhooks/abc123", value = "If trigger is `webhook`, this is the URL of the webhook to trigger the Automation.")
  ...
  **/
  @ApiModelProperty(example = "[ \"create\" ]", value = "If trigger is `action`, this is the list of action types on which to trigger the automation. Valid actions are create, read, update, destroy, move, copy")
  ...
  **/
  @ApiModelProperty(example = "path/to/file/or/folder", value = "If trigger is `action`, this is the path to watch for the specified trigger actions.")
   ...
   * @return value
  **/
  @ApiModelProperty(example = "\"{\\\"limit\\\": \\\"1\\\"}\"", value = "A Hash of attributes specific to the automation type.")
