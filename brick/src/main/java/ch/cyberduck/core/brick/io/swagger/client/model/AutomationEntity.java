...
public class AutomationEntity {
  ...
  **/
  @Schema(example = "2020-01-01T00:00:00.000Z", description = "If trigger is `daily`, date this automation will next run.")
  ...
  **/
   ...
   * @return schedule
  **/
  @Schema(example = "{\"days_of_week\":[0,2,4],\"time_zone\":\"Eastern Time (US & Canada)\",\"times_of_day\":[390,870]}", description = "If trigger is `custom_schedule`, Custom schedule description for when the automation should be run.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(automation, destinationReplaceFrom, destinationReplaceTo, destinations, groupIds, id, interval, nextProcessOn, path, schedule, source, trigger, triggerActionPath, triggerActions, userId, userIds, value, webhookUrl);
  }
