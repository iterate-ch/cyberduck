...
import ch.cyberduck.core.brick.io.swagger.client.model.RemoteServersBody;
import ch.cyberduck.core.brick.io.swagger.client.model.RemoteServersIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-12T12:23:43.971535+02:00[Europe/Paris]")public class RemoteServersApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public RemoteServerEntity patchRemoteServersId(Integer id, RemoteServersIdBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public RemoteServerEntity postRemoteServers(RemoteServersBody body) throws ApiException {
    Object localVarPostBody = body;
    // create path and map variables
    String localVarPath = "/remote_servers";
