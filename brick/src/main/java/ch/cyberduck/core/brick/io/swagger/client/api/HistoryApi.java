...
public class HistoryApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ActionEntity> listForFile(String path, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    return listForFileWithHttpInfo(path, startAt, endAt, display, cursor, perPage, sortBy).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ActionEntity>> listForFileWithHttpInfo(String path, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ActionEntity> listForFolder(String path, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    return listForFolderWithHttpInfo(path, startAt, endAt, display, cursor, perPage, sortBy).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ActionEntity>> listForFolderWithHttpInfo(String path, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ActionEntity> listForUser(Integer userId, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    return listForUserWithHttpInfo(userId, startAt, endAt, display, cursor, perPage, sortBy).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ActionEntity>> listForUserWithHttpInfo(Integer userId, DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ActionEntity> listLogins(DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    return listLoginsWithHttpInfo(startAt, endAt, display, cursor, perPage, sortBy).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<ActionEntity>> listLoginsWithHttpInfo(DateTime startAt, DateTime endAt, String display, String cursor, Integer perPage, Map<String, String> sortBy) throws ApiException {
    Object localVarPostBody = null;
