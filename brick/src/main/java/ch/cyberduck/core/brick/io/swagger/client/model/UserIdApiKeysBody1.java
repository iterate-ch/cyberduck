...
public class UserIdApiKeysBody1 {
  @JsonProperty("name")
  ...
  public UserIdApiKeysBody1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public UserIdApiKeysBody1 expiresAt(DateTime expiresAt) {
  ...
  **/
  ...
  public UserIdApiKeysBody1 permissionSet(PermissionSetEnum permissionSet) {
  ...
  **/
  ...
  public UserIdApiKeysBody1 path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserIdApiKeysBody1 userIdApiKeysBody1 = (UserIdApiKeysBody1) o;
    return Objects.equals(this.name, userIdApiKeysBody1.name) &&
        Objects.equals(this.expiresAt, userIdApiKeysBody1.expiresAt) &&
        Objects.equals(this.permissionSet, userIdApiKeysBody1.permissionSet) &&
        Objects.equals(this.path, userIdApiKeysBody1.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, expiresAt, permissionSet, path);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserIdApiKeysBody1 {\n");
