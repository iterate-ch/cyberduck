...
import ch.cyberduck.core.brick.io.swagger.client.model.MessageCommentsBody;
import ch.cyberduck.core.brick.io.swagger.client.model.MessageCommentsIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-25T22:25:43.390877+02:00[Europe/Paris]")public class MessageCommentsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageCommentEntity patchMessageCommentsId(MessageCommentsIdBody body, Integer id) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageCommentEntity postMessageComments(MessageCommentsBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
