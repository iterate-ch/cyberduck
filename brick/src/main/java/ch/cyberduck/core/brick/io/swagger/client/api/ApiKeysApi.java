...
public class ApiKeysApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<ApiKeyEntity> getApiKeys(Integer userId, String cursor, Integer perPage, Map<String, String> sortBy, Map<String, String> filter, Map<String, String> filterGt, Map<String, String> filterGteq, Map<String, String> filterLike, Map<String, String> filterLt, Map<String, String> filterLteq) throws ApiException {
    return getApiKeysWithHttpInfo(userId, cursor, perPage, sortBy, filter, filterGt, filterGteq, filterLike, filterLt, filterLteq).getData();
      }
  ...
  public ApiKeyEntity getApiKeysId(Integer id) throws ApiException {
    return getApiKeysIdWithHttpInfo(id).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiKeyEntity patchApiKeysId(Integer id, String name, DateTime expiresAt, String permissionSet) throws ApiException {
    return patchApiKeysIdWithHttpInfo(id, name, expiresAt, permissionSet).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApiKeyEntity> patchApiKeysIdWithHttpInfo(Integer id, String name, DateTime expiresAt, String permissionSet) throws ApiException {
    Object localVarPostBody = null;
...
if (permissionSet != null)
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiKeyEntity postApiKeys(Integer userId, String name, DateTime expiresAt, String permissionSet, String path) throws ApiException {
    return postApiKeysWithHttpInfo(userId, name, expiresAt, permissionSet, path).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ApiKeyEntity> postApiKeysWithHttpInfo(Integer userId, String name, DateTime expiresAt, String permissionSet, String path) throws ApiException {
    Object localVarPostBody = null;
