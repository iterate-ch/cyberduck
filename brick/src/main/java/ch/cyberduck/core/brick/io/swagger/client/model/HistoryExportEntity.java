 ...
 * Show History Export
 */
@ApiModel(description = "Show History Export")
...
public class HistoryExportEntity {
  ...
  **/
  @ApiModelProperty(example = "20201213.2", value = "Version of the history for the export.")
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "ready", value = "Status of export.  Will be: `building`, `ready`, or `failed`")
  ...
  **/
  @ApiModelProperty(example = "ftp", value = "Filter results by this this interface type. Valid values: `web`, `ftp`, `robot`, `jsapi`, `webdesktopapi`, `sftp`, `dav`, `desktop`, `restapi`, `scim`, `office`")
   ...
   * @return queryUserId
  **/
  @ApiModelProperty(example = "1", value = "Return results that are actions performed by the user indiciated by this User ID")
   ...
   * @return queryFileId
  **/
  @ApiModelProperty(example = "1", value = "Return results that are file actions related to the file indicated by this File ID")
  ...
  **/
  @ApiModelProperty(example = "1", value = "Return results that are file actions inside the parent folder specified by this folder ID")
   ...
   * @return queryPath
  **/
  @ApiModelProperty(example = "MyFile.txt", value = "Return results that are file actions related to this path.")
   ...
   * @return queryFolder
  **/
  @ApiModelProperty(example = "Folder", value = "Return results that are file actions related to files or folders inside this folder path.")
   ...
   * @return querySrc
  **/
  @ApiModelProperty(example = "SrcFolder", value = "Return results that are file moves originating from this path.")
  ...
  **/
  @ApiModelProperty(example = "DestFolder", value = "Return results that are file moves with this path as destination.")
   ...
   * @return queryIp
  **/
  @ApiModelProperty(example = "127.0.0.1", value = "Filter results by this IP address.")
  ...
  **/
  @ApiModelProperty(example = "jerry", value = "Filter results by this username.")
  ...
  **/
  @ApiModelProperty(example = "bad_password", value = "If searching for Histories about login failures, this parameter restricts results to failures of this specific type.  Valid values: `expired_trial`, `account_overdue`, `locked_out`, `ip_mismatch`, `password_mismatch`, `site_mismatch`, `username_not_found`, `none`, `no_ftp_permission`, `no_web_permission`, `no_directory`, `errno_enoent`, `no_sftp_permission`, `no_dav_permission`, `no_restapi_permission`, `key_mismatch`, `region_mismatch`, `expired_access`, `desktop_ip_mismatch`, `desktop_api_key_not_used_quickly_enough`, `disabled`, `country_mismatch`")
  ...
  **/
  @ApiModelProperty(example = "1", value = "If searching for Histories about specific objects (such as Users, or API Keys), this paremeter restricts results to objects that match this ID.")
  ...
  **/
  @ApiModelProperty(example = "full", value = "If searching for Histories about Users, Groups or other objects with names, this parameter restricts results to objects with this name/username.")
  ...
  **/
  @ApiModelProperty(example = "full", value = "If searching for Histories about Permisisons, this parameter restricts results to permissions of this level.")
  ...
  **/
  @ApiModelProperty(example = "1", value = "If searching for Histories about API keys, this parameter restricts results to API keys created by/for this user ID.")
  ...
  **/
  @ApiModelProperty(example = "jerry", value = "If searching for Histories about API keys, this parameter restricts results to API keys created by/for this username.")
  ...
  **/
  @ApiModelProperty(example = "windows", value = "If searching for Histories about API keys, this parameter restricts results to API keys associated with this platform.")
  ...
  **/
  @ApiModelProperty(example = "desktop_app", value = "If searching for Histories about API keys, this parameter restricts results to API keys with this permission set.")
   ...
   * @return resultsUrl
  **/
  @ApiModelProperty(example = "https://files.com/history_results.csv", value = "If `status` is `ready`, this will be a URL where all the results can be downloaded at once as a CSV.")
