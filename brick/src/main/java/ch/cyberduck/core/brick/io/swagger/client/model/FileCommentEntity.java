 ...
 */
@ApiModel(description = "List File Comments by path")
...
public class FileCommentEntity {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "File Comment ID")
   ...
   * @return body
  **/
  @ApiModelProperty(example = "What a great file!", value = "Comment body.")
