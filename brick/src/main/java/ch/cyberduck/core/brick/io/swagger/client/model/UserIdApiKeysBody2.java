...
public class UserIdApiKeysBody2 {
  @JsonProperty("name")
  ...
  public UserIdApiKeysBody2 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public UserIdApiKeysBody2 expiresAt(DateTime expiresAt) {
  ...
  **/
  ...
  public UserIdApiKeysBody2 permissionSet(PermissionSetEnum permissionSet) {
  ...
  **/
  ...
  public UserIdApiKeysBody2 path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserIdApiKeysBody2 userIdApiKeysBody2 = (UserIdApiKeysBody2) o;
    return Objects.equals(this.name, userIdApiKeysBody2.name) &&
        Objects.equals(this.expiresAt, userIdApiKeysBody2.expiresAt) &&
        Objects.equals(this.permissionSet, userIdApiKeysBody2.permissionSet) &&
        Objects.equals(this.path, userIdApiKeysBody2.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserIdApiKeysBody2 {\n");
