 ...
 */
@ApiModel(description = "List Bandwidth Snapshots")
...
public class BandwidthSnapshotEntity {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "Site bandwidth ID")
  ...
  **/
  @ApiModelProperty(example = "1.0", value = "Site bandwidth report bytes received")
   ...
   * @return bytesSent
  **/
  @ApiModelProperty(example = "1.0", value = "Site bandwidth report bytes sent")
  ...
  **/
  @ApiModelProperty(example = "1.0", value = "Site sync bandwidth report bytes received")
  ...
  **/
  @ApiModelProperty(example = "1.0", value = "Site sync bandwidth report bytes sent")
   ...
   * @return requestsGet
  **/
  @ApiModelProperty(example = "1.0", value = "Site bandwidth report get requests")
   ...
   * @return requestsPut
  **/
  @ApiModelProperty(example = "1.0", value = "Site bandwidth report put requests")
  ...
  **/
  @ApiModelProperty(example = "1.0", value = "Site bandwidth report other requests")
   ...
   * @return loggedAt
  **/
  @ApiModelProperty(example = "2000-01-01T01:00:00Z", value = "Time the site bandwidth report was logged")
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "2000-01-01T01:00:00Z", value = "Site bandwidth report created at date/time")
   ...
   * @return updatedAt
  **/
  @ApiModelProperty(example = "2000-01-01T01:00:00Z", value = "The last time this site bandwidth report was updated")
