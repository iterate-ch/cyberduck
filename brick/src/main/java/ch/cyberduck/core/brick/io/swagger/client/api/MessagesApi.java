...
import ch.cyberduck.core.brick.io.swagger.client.model.MessagesBody;
import ch.cyberduck.core.brick.io.swagger.client.model.MessagesIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-12T12:23:43.971535+02:00[Europe/Paris]")public class MessagesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageEntity patchMessagesId(MessagesIdBody body, Integer id) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageEntity postMessages(MessagesBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
