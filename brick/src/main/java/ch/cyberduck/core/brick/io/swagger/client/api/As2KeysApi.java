...
import ch.cyberduck.core.brick.io.swagger.client.model.As2KeysBody;
import ch.cyberduck.core.brick.io.swagger.client.model.As2KeysIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-12T12:23:43.971535+02:00[Europe/Paris]")public class As2KeysApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public As2KeyEntity patchAs2KeysId(As2KeysIdBody body, Integer id) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling patchAs2KeysId");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public As2KeyEntity postAs2Keys(As2KeysBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling postAs2Keys");
    }
    // create path and map variables
    String localVarPath = "/as2_keys";
