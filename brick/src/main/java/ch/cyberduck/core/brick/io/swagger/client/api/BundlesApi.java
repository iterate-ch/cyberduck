...
import ch.cyberduck.core.brick.io.swagger.client.model.BundlesIdBody;
import ch.cyberduck.core.brick.io.swagger.client.model.IdShareBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-12T12:23:43.971535+02:00[Europe/Paris]")public class BundlesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<BundleEntity> getBundles(Integer userId, String cursor, Integer perPage, Object sortBy, Object filter, Object filterGt, Object filterGteq, Object filterLike, Object filterLt, Object filterLteq) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public BundleEntity patchBundlesId(Integer id, BundlesIdBody body) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public BundleEntity postBundles(BundlesBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling postBundles");
    }
    // create path and map variables
    String localVarPath = "/bundles";
   ...
   * @throws ApiException if fails to make API call
   */
  public void postBundlesIdShare(Integer id, IdShareBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'id' is set
    if (id == null) {
