 ...
 * Create Bundle
 */
@ApiModel(description = "Create Bundle")
...
public class BundleEntity {
   ...
   * @return code
  **/
  @ApiModelProperty(example = "abc123", value = "Bundle code.  This code forms the end part of the Public URL.")
   ...
   * @return url
  **/
  @ApiModelProperty(example = "https://subdomain.files.com/f/12345678", value = "Public URL of Share Link")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "The public description of the bundle.", value = "Public description")
  ...
  **/
  @ApiModelProperty(value = "Is this bundle password protected?")
   ...
   * @return previewOnly
  **/
  @ApiModelProperty(value = "Restrict users to previewing files only?")
  ...
  **/
  @ApiModelProperty(value = "Show a registration page that captures the downloader's name and email address?")
  ...
  **/
  @ApiModelProperty(value = "Only allow access to recipients who have explicitly received the share via an email sent through the Files.com UI?")
  ...
  **/
  @ApiModelProperty(example = "[Legal text]", value = "Legal text that must be agreed to prior to accessing Bundle.")
   ...
   * @return formFieldSet
  **/
  @ApiModelProperty(value = "Custom Form to use")
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "Bundle ID")
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "2000-01-01T01:00:00Z", value = "Bundle created at date/time")
   ...
   * @return expiresAt
  **/
  @ApiModelProperty(example = "2000-01-01T01:00:00Z", value = "Bundle expiration date/time")
   ...
   * @return maxUses
  **/
  @ApiModelProperty(example = "1", value = "Maximum number of times bundle can be accessed")
   ...
   * @return note
  **/
  @ApiModelProperty(example = "The internal note on the bundle.", value = "Bundle internal note")
   ...
   * @return userId
  **/
  @ApiModelProperty(example = "1", value = "Bundle creator user ID")
   ...
   * @return username
  **/
  @ApiModelProperty(example = "user", value = "Bundle creator username")
   ...
   * @return clickwrapId
  **/
  @ApiModelProperty(example = "1", value = "ID of the clickwrap to use with this bundle.")
   ...
   * @return inboxId
  **/
  @ApiModelProperty(example = "1", value = "ID of the associated inbox, if available.")
   ...
   * @return hasInbox
  **/
  @ApiModelProperty(example = "true", value = "Does this bundle have an associated inbox?")
   ...
   * @return paths
  **/
  @ApiModelProperty(example = "[\"file.txt\"]", value = "A list of paths in this bundle")
