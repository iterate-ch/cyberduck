...
public class BundleEntity {
  ...
  **/
   ...
   * @return createdAt
  **/
  @Schema(example = "2000-01-01T01:00Z", description = "Bundle created at date/time")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clickwrapBody, clickwrapId, code, createdAt, description, expiresAt, formFieldSet, hasInbox, id, inboxId, maxUses, note, passwordProtected, paths, previewOnly, requireRegistration, requireShareRecipient, url, userId, username);
  }
