...
import ch.cyberduck.core.brick.io.swagger.client.model.AutomationsBody;
import ch.cyberduck.core.brick.io.swagger.client.model.AutomationsIdBody;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-07-25T22:25:43.390877+02:00[Europe/Paris]")public class AutomationsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<AutomationEntity> getAutomations(String cursor, Integer perPage, Object sortBy, Object filter, Object filterGt, Object filterGteq, Object filterLike, Object filterLt, Object filterLteq, String automation) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
   ...
   * @throws ApiException if fails to make API call
   */
  public AutomationEntity patchAutomationsId(AutomationsIdBody body, Integer id) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling patchAutomationsId");
    }
    // verify the required parameter 'id' is set
    if (id == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public AutomationEntity postAutomations(AutomationsBody body) throws ApiException {
    Object localVarPostBody = body;
    // verify the required parameter 'body' is set
    if (body == null) {
