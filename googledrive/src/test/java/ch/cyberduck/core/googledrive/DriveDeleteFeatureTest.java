...
public class DriveDeleteFeatureTest extends AbstractDriveTest {
    ...
    public void testDeleteFromTrash() throws Exception {
        ...
        new DriveDeleteFeature(session, fileid).delete(Collections.singletonList(file), new DisabledPasswordCallback(), new Delete.DisabledCallback());
        ...
        new DriveDeleteFeature(session, fileid).delete(Collections.singletonList(file.withAttributes(attributesInTrash)), new DisabledPasswordCallback(), new Delete.DisabledCallback());
