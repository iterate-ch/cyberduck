...
public class DriveBatchDeleteFeatureTest extends AbstractDriveTest {
    ...
    public void testDeleteNotFound() throws Exception {
        ...
        new DriveBatchDeleteFeature(session, new DriveFileidProvider(session).withCache(cache)).delete(Collections.singletonList(test), new DisabledLoginCallback(), new Delete.DisabledCallback());
    }
}
