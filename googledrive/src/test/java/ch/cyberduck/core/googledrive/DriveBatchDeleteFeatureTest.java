...
public class DriveBatchDeleteFeatureTest extends AbstractDriveTest {
    ...
    public void testDeleteFromTrash() throws Exception {
        ...
        new DriveBatchDeleteFeature(session, fileid).delete(Collections.singletonList(file), new DisabledPasswordCallback(), new Delete.DisabledCallback());
        ...
        assertTrue(attributesInTrash.isDuplicate());
        new DriveBatchDeleteFeature(session, fileid).delete(Collections.singletonList(file.withAttributes(attributesInTrash)), new DisabledPasswordCallback(), new Delete.DisabledCallback());
