...
public class FTPListServiceTest extends AbstractFTPTest {
    ...
    public void testListCryptomator() throws Exception {
        ...
        assertTrue(new CryptoListService(session, new FTPListService(session, null, null), new DefaultFindFeature(session), cryptomator).list(vault, new DisabledListProgressListener()).isEmpty());
        ...
        assertEquals(test, new CryptoListService(session, new FTPListService(session, null, null), new DefaultFindFeature(session), cryptomator).list(vault, new DisabledListProgressListener()).get(0));
