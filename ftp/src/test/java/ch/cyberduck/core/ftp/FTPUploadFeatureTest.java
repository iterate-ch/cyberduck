...
public class FTPUploadFeatureTest extends AbstractFTPTest {
    ...
    public void testAppend() throws Exception {
        ...
        assertTrue(new FTPUploadFeature().append(f, new TransferStatus().setExists(true).setLength(0L).setRemote(new FTPAttributesFinderFeature(session).find(f))).append);
