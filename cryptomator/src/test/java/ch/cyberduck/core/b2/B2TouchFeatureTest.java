...
public class B2TouchFeatureTest {
    ...
    public void testTouchEncrypted() throws Exception {
        ...
        new CryptoTouchFeature<BaseB2Response>(session, new B2TouchFeature(session), new B2WriteFeature(session), cryptomator).touch(test, new TransferStatus());
    ...
    public void testTouchEncryptedDefaultFeature() throws Exception {
        ...
        session.withRegistry(new DefaultVaultRegistry(new DisabledPasswordStore(), new DisabledPasswordCallback(), cryptomator));
        new CryptoTouchFeature<BaseB2Response>(session, new DefaultTouchFeature<BaseB2Response>(new B2SingleUploadService(new B2WriteFeature(session))), new B2WriteFeature(session, null), cryptomator).touch(test, new TransferStatus());
