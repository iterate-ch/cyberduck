...
public class MoveWorkerTest {
    ...
    public void testMoveFolder() throws Exception {
        ...
        new CryptoDeleteFeature(session, new DropboxDeleteFeature(session), cryptomator).delete(Arrays.asList(fileRenamedInRenamedFolder, folderRenamed), new DisabledLoginCallback(), new Delete.DisabledCallback());
        session.close();
    }
