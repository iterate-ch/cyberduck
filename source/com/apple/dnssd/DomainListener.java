...
public interface DomainListener extends BaseListener {
     ...
     *
     * @param    domainEnum The active domain enumerator.
     * @param    flags Possible values are: DNSSD.MORE_COMING, DNSSD.DEFAULT
     * <p/>
     * @param    ifIndex Specifies the interface on which the domain exists.  (The index for a given
