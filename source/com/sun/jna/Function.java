...
public class Function extends Pointer {
     ...
     * convention.
     *
     * @param libraryName  Library in which to find the native function
     ...
     *
     * @param libraryName  Library in which to find the function
     * @param functionName Name of the native function to be linked with
     ...
     * convention.
     *
     * @param functionAddress Address of the native function
     * @param callFlags       Function <a href="#callflags">call flags</a>
     */
