...
public abstract class TransportProtocolCommon implements TransportProtocol, Runnable {
    ...
    /**  */
    public static String SOFTWARE_VERSION_COMMENTS = "J2SSH (Cyberduck)";
    ...
    public void run() {
        try {
            ...
            //todo compare with previous cvs version
        ...
        synchronized (kexLock) {
            ...
            if (msg.firstPacketFollows()) {
                ...
                if (msg.getSupportedKex().get(0).equals(properties.getPrefCSMac())
                        && msg.getSupportedPublicKeys().get(0).equals(properties.getPrefPublicKey())) {
                    useFirstPacket = true;
                }
            }
