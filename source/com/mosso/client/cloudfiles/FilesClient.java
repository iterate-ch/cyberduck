...
public class FilesClient
{
    ...
    public List<FilesContainer> listContainers() throws IOException, HttpException, FilesAuthorizationException
    {
        if (this.isLoggedin())
        {
            ...
            logger.warn ("You need to first login to the account before you perform this operation.");
    ...
    public List<FilesObject> listObjectsStaringWith (String container, String startsWith) throws IOException, HttpException
    {
    	if (this.isLoggedin())
    	{
    		if (StringUtils.isNotBlank(container) && container.indexOf('/') == -1)
    		{
    		...
    		{
    			logger.info ("The Name supplied was null, empty or contained a slash: "+ container);
    		}
    	}
    	else
    		logger.warn ("You need to first login to the account before you perform this operation.");
    ...
    public List<FilesObject> listObjects (String container) throws IOException, HttpException
    {
    	if (this.isLoggedin())
    	{
    		...
    		logger.info ("You need to first login to the account before you perform this operation.");
    ...
    {
        FilesContainerInfo containerInfo = this.getContainerInfo(container);
   ...
   public FilesAccountInfo getAccountInfo() throws IOException, HttpException{
    ...
    public int createContainer(String name) throws IOException, HttpException
    {
    	...
    	if (this.isLoggedin())
    	{
    		...
    		{
    			logger.info ("The Name supplied was invalid: "+ name);
    		}
    	}
    	return returnCode;
    }
    	...
    	if (isLoggedin()) {
    		if (StringUtils.isNotBlank(container) && container.indexOf('/') == -1)
    		{
    			...
    			FilesResponse response = new FilesResponse(method);
     			...
     			if (response.getStatusCode() == HttpStatus.SC_NO_CONTENT)
    			{
    				result = new FilesCDNContainer(response.getCdnUrl());
...
//    					}
    		...
    		{
    			logger.info ("The name supplied was invalid: "+ container);
    		}
    	}
    	return result;
    }
     ...
     * @throws NoSuchAlgorithmException
     */
    public int storeObjectAs(String container, String name, InputStream in, long contentLength, String contentType, String md5sum) throws IOException, HttpException, NoSuchAlgorithmException
    {
     ...
     * @throws NoSuchAlgorithmException
     */
    public int storeObjectAs(String container, String name, InputStream in, long contentLength, String contentType, Map<String,String> metadata, String md5sum) throws IOException, HttpException, NoSuchAlgorithmException
    {
     ...
     * @throws NoSuchAlgorithmException
     */
    public int storeObjectAs(String container, String name, RequestEntity entity, Map<String,String> metadata, String md5sum) throws IOException, HttpException, NoSuchAlgorithmException
    {
    	int returnCode = -1;
    	...
    	if (this.isLoggedin())
    	{
    		...
    		{
    			logger.warn ("The Container or Object name is invalid");
    		}
    	}
    	return returnCode;
    }
    ...
    public int deleteObject (String container, String objName) throws IOException, HttpException
    {
    	...
    	if (this.isLoggedin())
    	{
    		if (StringUtils.isNotBlank(container) && StringUtils.isNotBlank(objName) && container.indexOf('/') == -1)
    		{
    			if (objName.length() > 128)
    			{
    				logger.warn ("Object Name supplied was truncated to Max allowed of 128 characters !");
    		...
    		{
    			logger.info ("The Container or Object Name supplied was invalid: ");
    		}
    	}
    	return returnCode;
    }
