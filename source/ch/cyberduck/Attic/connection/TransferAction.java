 ...
 * @see ch.cyberduck.connection.Bookmark#transfer
 * @version $Id$
 */
public class TransferAction implements java.io.Serializable {
    ...
    public TransferAction(String action, Object param1, Object param2) {
        //Cyberduck.DEBUG("[TransferAction] TransferAction(" + action + "," +  param2 + ")");
        this.action = action;
        this.param1 = param1;
        this.param2 = param2;
    }
    ...
    public TransferAction(String action, Object param1) {
        //Cyberduck.DEBUG("[TransferAction] TransferAction(" + action + "," +  param1 + ")");
        this.action = action;
        this.param1 = param1;
    }
