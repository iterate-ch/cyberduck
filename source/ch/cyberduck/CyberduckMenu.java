...
/*
 *  ch.cyberduck.CyberduckMenu.java
 *  Cyberduck
 *
 *  $Header$
 *  $Revision$
...
//import ch.cyberduck.menu.MenuAction;

/**
 * Singleton available application wide
 */
public class CyberduckMenu extends JMenuBar {

    private static CyberduckMenu instance = null;
...
//    private MenuAction[] menus = new MenuAction[NO_MENUS];
    ...
    public static CyberduckMenu instance() {
        if(instance == null) {
            instance = new CyberduckMenu();
        }
        return instance;
    }
