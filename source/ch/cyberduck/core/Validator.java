...
public abstract class Validator {
    ...
    private boolean validateDirectory(Path path) {
    ...
    private void proposeLocalFilename(Path path) {
    ...
    private void proposeRemoteFilename(Path path) {
