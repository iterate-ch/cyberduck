...
#include <jni.h>
/* Header for class ch_cyberduck_core_SystemConfigurationReachability */

#ifndef _Included_ch_cyberduck_core_SystemConfigurationReachability
#define _Included_ch_cyberduck_core_SystemConfigurationReachability
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     ch_cyberduck_core_SystemConfigurationReachability
 * Method:    isReachable
