...
public class GDSession extends SSLSession {
    ...
    protected void connect() throws IOException {
        ...
        client = new DocsService(this.getUserAgent(),
                new CustomTrustRequestFactory(),
                new CustomTrustGoogleAuthTokenFactory(
                        client, DocsService.DOCS_SERVICE, this.getUserAgent()
                ));
    ...
    protected class CustomTrustGoogleAuthTokenFactory extends GoogleAuthTokenFactory {
        ...
        public String getAuthToken(String username,
            ...
            String postOutput;
            try {
                URL url = new URL("https" + "://" + "www.google.com" + GOOGLE_LOGIN_PATH);
        ...
        private AuthenticationException getAuthException(Map<String, String> pairs) {
            ...
            if("BadAuthentication".equals(errorName)) {
                ...
                captchaUrl.append("https").append("://").append("www.google.com")
         ...
         * @throws java.io.IOException if an I/O exception occurs while creating, writing,
