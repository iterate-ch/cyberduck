#include <jni.h>
/* Header for class ch_cyberduck_ui_cocoa_growl_GrowlNative */

#ifndef _Included_ch_cyberduck_ui_cocoa_growl_GrowlNative
#define _Included_ch_cyberduck_ui_cocoa_growl_GrowlNative
#ifdef __cplusplus
extern "C" {
#endif
	...
	/*
	 * Class:     ch_cyberduck_ui_cocoa_growl_GrowlNative
	 * Method:    register
	 * Signature: ()V
	 */
