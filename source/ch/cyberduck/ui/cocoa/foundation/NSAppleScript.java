 ...
 */
public abstract class NSAppleScript implements NSObject {
	 ...
	 */
	public abstract NSAppleScript initWithContentsOfURL_error(com.sun.jna.Pointer url, com.sun.jna.ptr.ByReference errorInfo);
	/**
	 * Factory method<br>
	 * @see #initWithContentsOfURL_error(com.sun.jna.Pointer, com.sun.jna.ptr.ByReference)
	 */
	public static NSAppleScript createWithContentsOfURL_error(com.sun.jna.Pointer url, com.sun.jna.ptr.ByReference errorInfo) {
