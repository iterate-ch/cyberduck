 ...
 * @version $Id$
 */
public class HostKeyController extends ProxyController implements ServerHostKeyVerifier {
    ...
    public HostKeyController(final WindowController windowController) {
