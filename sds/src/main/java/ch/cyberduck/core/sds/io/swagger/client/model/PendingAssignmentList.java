...
public class PendingAssignmentList {
  ...
  @JsonProperty("items")
  private List<PendingAssignment> items = new ArrayList<PendingAssignment>();
  ...
  **/
  ...
  public PendingAssignmentList items(List<PendingAssignment> items) {
    this.items = items;
    return this;
  }

  public PendingAssignmentList addItemsItem(PendingAssignment itemsItem) {
