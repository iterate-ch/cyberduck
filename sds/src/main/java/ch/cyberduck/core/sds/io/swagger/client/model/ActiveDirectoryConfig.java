...
public class ActiveDirectoryConfig {
  ...
  **/
   ...
   * @return alias
  **/
  @ApiModelProperty(example = "null", required = true, value = "Unique name for an active directory configuration")
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Determines whether a room is created for each user that is created by automatic import (Like a home folder). The room's name will equal the user's login name.")
