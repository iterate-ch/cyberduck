...
public class UserItem {
  ...
  **/
  ...
  public UserItem createdAt(Date createdAt) {
   ...
   * @return createdAt
  **/
  @ApiModelProperty(example = "null", value = "Account creation date (2015-12-31T23:59:00).")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, isEncryptionEnabled, hasManageableRooms, userRoles, lockStatus, expireAt, createdAt, lastLoginSuccessAt, login, email, title, gender, firstName, lastName, userAttributes);
  }
