...
public class SDSTouchFeatureTest {
    ...
    public void testTouchFileRoot() throws Exception {
        ...
        try {
            ...
            assertEquals("-80001. Please contact your web hosting service provider for assistance.", e.getDetail());
            throw e;
        }
        session.close();
    }
    ...
    public void testInvalidName() throws Exception {
        ...
        try {
            ...
            assertEquals("-40755. Please contact your web hosting service provider for assistance.", e.getDetail());
            throw e;
        }
        finally {
