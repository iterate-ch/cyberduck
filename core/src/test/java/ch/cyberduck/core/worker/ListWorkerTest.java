...
public class ListWorkerTest {
    ...
    public void testRun() throws Exception {
        ...
        assertFalse(cache.containsKey(directory));
    ...
    public void testCacheNotFoundWithController() throws Exception {
        ...
        final PathCache cache = new PathCache(1);
        final Path directory = new Path(new AlphanumericRandomStringService().random(), EnumSet.of(Path.Type.directory));
        final ListWorker worker = new ListWorker(cache, directory, new DisabledListProgressListener());
