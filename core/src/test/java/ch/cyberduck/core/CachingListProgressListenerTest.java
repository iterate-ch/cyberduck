...
public class CachingListProgressListenerTest {
    ...
    public void testEmptyList() throws Exception {
        ...
        final CachingListProgressListener listener = new CachingListProgressListener(new DisabledListProgressListener(), cache);
        ...
        listener.finish(directory, new AttributedList<>(), Optional.empty());
