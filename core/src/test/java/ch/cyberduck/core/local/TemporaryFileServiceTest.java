...
public class TemporaryFileServiceTest {
    ...
    public void testCreateFile() throws Exception {
        ...
        assertEquals(PathNormalizer.normalize(String.format("%s%su%sp%sf", temp, s, s, s)),
    ...
    public void testVersion() throws Exception {
        ...
        final String s = System.getProperty("file.separator");
        {
            ...
            assertEquals(PathNormalizer.normalize(String.format("%s%su%sp%s2%sf", temp, s, s, s, s)),
                    new TemporaryFileService().create("u", file).getAbsolute());
        }
        {
            ...
            file.attributes().setRegion("region");
            file.attributes().setVersionId("2");
            assertEquals(PathNormalizer.normalize(String.format("%s%su%sregion2%sp", temp, s, s, s)),
                    new TemporaryFileService().create("u", file).getAbsolute());
        }
    }
