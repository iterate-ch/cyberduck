 ...
 */
JNIEXPORT jboolean JNICALL Java_ch_cyberduck_core_Keychain_addPasswordToKeychain
 ...
 */
JNIEXPORT jboolean JNICALL Java_ch_cyberduck_core_Keychain_addInternetPasswordToKeychain
