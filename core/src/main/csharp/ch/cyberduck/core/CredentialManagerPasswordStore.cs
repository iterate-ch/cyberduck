...
namespace Ch.Cyberduck.Core
{
    ...
    {
        private static readonly Logger log = Logger.getLogger(nameof(CredentialManagerPasswordStore));
        ...
        OAuthTokens HostPasswordStore.findOAuthTokens(Host bookmark)
        {
            ...
            return new OAuthTokens(accessToken, refreshToken, Long.valueOf(expiry));
        }
