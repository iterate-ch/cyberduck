...
namespace Ch.Cyberduck.Core.TaskDialog
{
    ...
    public static class TaskDialog
    {
        ...
        /// </remarks>
        public static int GetButtonIndexForCommonButton(TASKDIALOG_COMMON_BUTTON_FLAGS commonButtons, int buttonId)
        {
            switch (commonButtons)
            {
                ...
                case TDCBF_CLOSE_BUTTON:
                    return 0;
                case TDCBF_OK_BUTTON | TDCBF_CANCEL_BUTTON:
                    if (buttonId == (int)TaskDialogSimpleResult.Ok
                        || buttonId == (int)TDCBF_OK_BUTTON)
                        return 0;
                    else if (buttonId == (int)TaskDialogSimpleResult.Cancel
                        || buttonId == (int)TDCBF_CANCEL_BUTTON)
                        return 1;
                    break;
                case TDCBF_RETRY_BUTTON | TDCBF_CANCEL_BUTTON:
                    if (buttonId == (int)TaskDialogSimpleResult.Retry
                        || buttonId == (int)TDCBF_RETRY_BUTTON)
                        return 0;
                    else if (buttonId == (int)TaskDialogSimpleResult.Cancel
                        || buttonId == (int)TDCBF_CANCEL_BUTTON)
                        return 1;
                    break;
                case TDCBF_YES_BUTTON | TDCBF_NO_BUTTON:
                    if (buttonId == (int)TaskDialogSimpleResult.Yes
                        || buttonId == (int)TDCBF_YES_BUTTON)
                        return 0;
                    else if (buttonId == (int)TaskDialogSimpleResult.No
                        || buttonId == (int)TDCBF_NO_BUTTON)
                        return 1;
                    break;

                case TDCBF_YES_BUTTON | TDCBF_NO_BUTTON | TDCBF_CANCEL_BUTTON:
                    if (buttonId == (int)TaskDialogSimpleResult.Yes
                        || buttonId == (int)TDCBF_YES_BUTTON)
                        return 0;
                    else if (buttonId == (int)TaskDialogSimpleResult.No
        ...
        public static TASKDIALOG_COMMON_BUTTON_FLAGS GetButtonIdForCommonButton(TASKDIALOG_COMMON_BUTTON_FLAGS commonButtons, int index)
        {
            switch (commonButtons)
            {
                default:
