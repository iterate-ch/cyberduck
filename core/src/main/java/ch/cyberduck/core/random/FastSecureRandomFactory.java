...
public class FastSecureRandomFactory extends DefaultSecureRandomFactory implements SecureRandomFactory {

    private static final Object lock = new Object();

    private static FastSecureRandomFactory factory;

    public static FastSecureRandomFactory get() {
        synchronized(lock) {
            if(null == factory) {
                factory = new FastSecureRandomFactory();
            }
            return factory;
        }
    }
