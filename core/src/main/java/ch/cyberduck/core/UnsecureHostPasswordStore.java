...
public class UnsecureHostPasswordStore extends DefaultHostPasswordStore {
    ...
    private Properties load() throws AccessDeniedException {
        ...
        if(file.exists()) {
            try {
                ...
                log.warn("Failure reading credentials from {}. {}", file.getAbsolute(), e);
    ...
    @Override
    public void deletePassword(final String serviceName, final String accountName) throws AccessDeniedException {
        final Properties properties = this.load();
