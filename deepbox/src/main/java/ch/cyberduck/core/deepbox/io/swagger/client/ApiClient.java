...
import ch.cyberduck.core.deepbox.io.swagger.client.auth.Authentication;
import ch.cyberduck.core.deepbox.io.swagger.client.auth.HttpBasicAuth;
import ch.cyberduck.core.deepbox.io.swagger.client.auth.ApiKeyAuth;
import ch.cyberduck.core.deepbox.io.swagger.client.auth.OAuth;


public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://api.deepbox.swiss";
