...
public class DeepboxExceptionMappingService extends AbstractExceptionMappingService<ApiException> {
    private static final Logger log = LogManager.getLogger(DeepboxExceptionMappingService.class);

    private final DeepboxIdProvider fileid;

    public DeepboxExceptionMappingService(final DeepboxIdProvider fileid) {
        this.fileid = fileid;
    }
