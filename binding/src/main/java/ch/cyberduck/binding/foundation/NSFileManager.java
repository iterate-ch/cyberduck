...
public abstract class NSFileManager extends NSObject {
     ...
     */
    public abstract boolean moveItemAtPath_toPath_error(String srcPath, String dstPath, ObjCObjectByReference error);
     ...
     */
    public abstract boolean linkItemAtPath_toPath_error(String srcPath, String dstPath, ObjCObjectByReference error);
     ...
     */
    public abstract boolean moveItemAtURL_toURL_error(NSURL srcURL, NSURL dstURL, ObjCObjectByReference error);
     ...
     */
    public abstract boolean linkItemAtURL_toURL_error(NSURL srcURL, NSURL dstURL, ObjCObjectByReference error);
