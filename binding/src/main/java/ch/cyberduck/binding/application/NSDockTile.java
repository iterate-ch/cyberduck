...
public abstract class NSDockTile extends NSObject {
    ...
    /**
     * get the size of the dock tile, in screen coordinates<br> Original signature : <code>-(NSSize)size</code><br>
     ...
     * you must call -[NSDockTile display].<br> Original signature : <code>-(void)setContentView:(NSView*)</code><br>
     ...
     * is YES for NSWindow dock tiles, NO for the NSApplication dock tile.<br> Original signature :
     * <code>-(void)setShowsApplicationBadge:(BOOL)</code><br>
    ...
    /**
     * -owner will return NSApp for the application dock tile, or the NSWindow for a mini window dock tile.<br> Original
     * signature : <code>-(id)owner</code><br>
