...
public abstract class NSColor extends NSObject implements NSCopying {
    ...
    public static NSColor labelColor() {
        if(Rococoa.cast(CLASS, NSColor.class).respondsToSelector(Foundation.selector("labelColor"))) {
    ...
    public static NSColor secondaryLabelColor() {
        if(Rococoa.cast(CLASS, NSColor.class).respondsToSelector(Foundation.selector("secondaryLabelColor"))) {
    ...
    public static NSColor tertiaryLabelColor() {
        if(Rococoa.cast(CLASS, NSColor.class).respondsToSelector(Foundation.selector("tertiaryLabelColor"))) {
    ...
    public static NSColor quaternaryLabelColor() {
        if(Rococoa.cast(CLASS, NSColor.class).respondsToSelector(Foundation.selector("quaternaryLabelColor"))) {
    ...
    public static NSColor placeholderTextColor() {
        if(Rococoa.cast(CLASS, NSColor.class).respondsToSelector(Foundation.selector("placeholderTextColor"))) {
    ...
    /**
     * Original signature : <code>NSColor* controlShadowColor()</code><br> Dark border for controls<br>
    ...
    /**
     * Original signature : <code>NSColor* controlDarkShadowColor()</code><br> Darker border for controls<br>
    ...
    /**
     * Original signature : <code>NSColor* controlColor()</code><br> Control face and old window background color<br>
    ...
    /**
     * Original signature : <code>NSColor* controlHighlightColor()</code><br> Light border for controls<br>
    ...
    /**
     * Original signature : <code>NSColor* controlLightHighlightColor()</code><br> Lighter border for controls<br>
    ...
    /**
     * Original signature : <code>NSColor* controlTextColor()</code><br> Text on controls<br>
    ...
    /**
     * Original signature : <code>NSColor* controlBackgroundColor()</code><br> Background of large controls (browser,
     * tableview, clipview, ...)<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedControlColor()</code><br> Control face for selected controls<br>
    ...
    /**
     * Original signature : <code>NSColor* secondarySelectedControlColor()</code><br> Color for selected controls when
     * control is not active (that is, not focused)<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedControlTextColor()</code><br> Text on selected controls<br>
    ...
    /**
     * Original signature : <code>NSColor* disabledControlTextColor()</code><br> Text on disabled controls<br>
    ...
    /**
     * Original signature : <code>NSColor* textColor()</code><br> Document text<br>
    ...
    /**
     * Original signature : <code>NSColor* textBackgroundColor()</code><br> Document text background<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedTextColor()</code><br> Selected document text<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedTextBackgroundColor()</code><br> Selected document text
     * background<br>
    ...
    /**
     * Original signature : <code>NSColor* gridColor()</code><br> Grids in controls<br>
    ...
    /**
     * Original signature : <code>NSColor* keyboardFocusIndicatorColor()</code><br> Keyboard focus ring around
     * controls<br>
    ...
    /**
     * Original signature : <code>NSColor* windowBackgroundColor()</code><br> Background fill for window contents<br>
    ...
    /**
     * Original signature : <code>NSColor* scrollBarColor()</code><br> Scroll bar slot color<br>
    ...
    /**
     * Original signature : <code>NSColor* knobColor()</code><br> Knob face color for controls<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedKnobColor()</code><br> Knob face color for selected controls<br>
    ...
    /**
     * Original signature : <code>NSColor* windowFrameColor()</code><br> Window frames<br>
    ...
    /**
     * Original signature : <code>NSColor* windowFrameTextColor()</code><br> Text on window frames<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedMenuItemColor()</code><br> Highlight color for menus<br>
    ...
    /**
     * Original signature : <code>NSColor* selectedMenuItemTextColor()</code><br> Highlight color for menu text<br>
    ...
    /**
     * Original signature : <code>NSColor* highlightColor()</code><br> Highlight color for UI elements (this is abstract
     * and defines the color all highlights tend toward)<br>
    ...
    /**
     * Original signature : <code>NSColor* shadowColor()</code><br> Shadow color for UI elements (this is abstract and
     * defines the color all shadows tend toward)<br>
    ...
    /**
     * Original signature : <code>NSColor* headerColor()</code><br> Background color for header cells in
     * Table/OutlineView<br>
    ...
    /**
     * Original signature : <code>NSColor* headerTextColor()</code><br> Text color for header cells in
     * Table/OutlineView<br>
    ...
    /**
     * Original signature : <code>NSColor* alternateSelectedControlColor()</code><br> Similar to selectedControlColor;
     * for use in lists and tables<br>
    ...
    /**
     * Original signature : <code>NSColor* alternateSelectedControlTextColor()</code><br> Similar to
     * selectedControlTextColor; see alternateSelectedControlColor<br>
    ...
    public interface _Class extends ObjCClass {
        /**
         * Create NSCalibratedWhiteColorSpace colors.<br> Original signature : <code>NSColor*
         * colorWithCalibratedWhite(CGFloat, CGFloat)</code><br>
         * <i>native declaration : :39</i>
         */
        NSColor colorWithCalibratedWhite_alpha(CGFloat white, CGFloat alpha);

        /**
         * Create NSCalibratedRGBColorSpace colors.<br> Original signature : <code>NSColor*
         * colorWithCalibratedHue(CGFloat, CGFloat, CGFloat, CGFloat)</code><br>
         ...
         * device-dependent operators setgray, sethsbcolor, setrgbcolor, and setcmykcolor.<br> Original signature :
         * <code>NSColor* colorWithDeviceWhite(CGFloat, CGFloat)</code><br>
        ...
        /**
         * Original signature : <code>NSColor* colorWithDeviceRed(CGCGFloat, CGCGFloat, CGCGFloat,
         * CGCGFloat)</code><br>
        ...
        /**
         * Original signature : <code>NSColor* colorWithDeviceCyan(CGFloat, CGFloat, CGFloat, CGFloat,
         * CGFloat)</code><br>
        ...
        /**
         * Create named colors from standard color catalogs (such as Pantone).<br> Original signature : <code>NSColor*
         * colorWithCatalogName(NSString*, NSString*)</code><br>
         ...
         * exception will be raised.  If the colorspace is one which cannot be used with NSColors, nil is returned.<br>
        ...
        /**
         * Some convenience methods to create colors in the calibrated color spaces...<br> Original signature :
         * <code>NSColor* blackColor()</code><br> 0.0 white<br>
         * <i>native declaration : :70</i>
         */
        NSColor blackColor();

        /**
         * Original signature : <code>NSColor* darkGrayColor()</code><br> 0.333 white<br>
         * <i>native declaration : :71</i>
         */
        NSColor darkGrayColor();

        /**
         * Original signature : <code>NSColor* lightGrayColor()</code><br> 0.667 white<br>
         * <i>native declaration : :72</i>
         */
        NSColor lightGrayColor();

        /**
         * Original signature : <code>NSColor* whiteColor()</code><br> 1.0 white<br>
         * <i>native declaration : :73</i>
         */
        NSColor whiteColor();

        /**
         * Original signature : <code>NSColor* grayColor()</code><br> 0.5 white<br>
         * <i>native declaration : :74</i>
         */
        NSColor grayColor();

        /**
         * Original signature : <code>NSColor* redColor()</code><br> 1.0, 0.0, 0.0 RGB<br>
         * <i>native declaration : :75</i>
         */
        NSColor redColor();

        /**
         * Original signature : <code>NSColor* greenColor()</code><br> 0.0, 1.0, 0.0 RGB<br>
         * <i>native declaration : :76</i>
         */
        NSColor greenColor();

        /**
         * Original signature : <code>NSColor* blueColor()</code><br> 0.0, 0.0, 1.0 RGB<br>
         * <i>native declaration : :77</i>
         */
        NSColor blueColor();

        /**
         * Original signature : <code>NSColor* cyanColor()</code><br> 0.0, 1.0, 1.0 RGB<br>
         * <i>native declaration : :78</i>
         */
        NSColor cyanColor();

        /**
         * Original signature : <code>NSColor* yellowColor()</code><br> 1.0, 1.0, 0.0 RGB<br>
         * <i>native declaration : :79</i>
         */
        NSColor yellowColor();

        /**
         * Original signature : <code>NSColor* magentaColor()</code><br> 1.0, 0.0, 1.0 RGB<br>
         * <i>native declaration : :80</i>
         */
        NSColor magentaColor();

        /**
         * Original signature : <code>NSColor* orangeColor()</code><br> 1.0, 0.5, 0.0 RGB<br>
         * <i>native declaration : :81</i>
         */
        NSColor orangeColor();

        /**
         * Original signature : <code>NSColor* purpleColor()</code><br> 0.5, 0.0, 0.5 RGB<br>
         * <i>native declaration : :82</i>
         */
        NSColor purpleColor();

        /**
         * Original signature : <code>NSColor* brownColor()</code><br> 0.6, 0.4, 0.2 RGB<br>
         * <i>native declaration : :83</i>
         */
        NSColor brownColor();

        /**
         * Original signature : <code>NSColor* clearColor()</code><br> 0.0 white, 0.0 alpha<br>
        ...
        /**
         * Original signature : <code>NSColor* controlColor()</code><br> Control face and old window background
         * color<br>
         * <i>native declaration : :88</i>
         */
        ...
        /**
         * Original signature : <code>NSColor* controlBackgroundColor()</code><br> Background of large controls
         * (browser, tableview, clipview, ...)<br>
         * <i>native declaration : :92</i>
         */
        ...
        /**
         * Original signature : <code>NSColor* secondarySelectedControlColor()</code><br> Color for selected controls
         * when control is not active (that is, not focused)<br>
         * <i>native declaration : :94</i>
         */
        ...
        /**
         * Original signature : <code>NSColor* windowBackgroundColor()</code><br> Background fill for window
         * contents<br>
         * <i>native declaration : :103</i>
         */
        ...
        /**
         * Original signature : <code>NSColor* highlightColor()</code><br> Highlight color for UI elements (this is
         * abstract and defines the color all highlights tend toward)<br>
         * <i>native declaration : :115</i>
         */
        NSColor highlightColor();

        /**
         * Original signature : <code>NSColor* shadowColor()</code><br> Shadow color for UI elements (this is abstract
         * and defines the color all shadows tend toward)<br>
         * <i>native declaration : :116</i>
         */
        NSColor shadowColor();
        ...
        /**
         * Original signature : <code>NSColor* alternateSelectedControlColor()</code><br> Similar to
         * selectedControlColor; for use in lists and tables<br>
         * <i>native declaration : :122</i>
         */
        ...
        /**
         * Original signature : <code>NSArray* controlAlternatingRowBackgroundColors()</code><br> Standard colors for
         ...
         */
        /**
         * Original signature : <code>currentControlTint()</code><br> returns current system control tint<br>
         * <i>native declaration : :136</i>
         */
        com.sun.jna.Pointer currentControlTint();

        /**
         * Pasteboard methods<br> Original signature : <code>NSColor* colorFromPasteboard(NSPasteboard*)</code><br>
         ...
         * apps linked post-10.1.x.<br> Original signature : <code>NSColor* colorWithPatternImage(NSImage*)</code><br>
         ...
         * "NSIgnoreAlpha" default to NO or call the set method below.<br> This method provides a global approach to
         * removing alpha which might not always be appropriate. Applications which need to import alpha sometimes
         * should set this flag to NO and explicitly make colors opaque in cases where it matters to them.<br> Original
         * signature : <code>void setIgnoresAlpha(BOOL)</code><br>
...
//        NSColor colorWithCIColor(CIColor color);
    ...
    /**
     * Original signature : <code>NSColor* highlightWithLevel(CGFloat)</code><br> val = 0 => receiver, val = 1 =>
     * highlightColor<br>
    ...
    /**
     * Original signature : <code>NSColor* shadowWithLevel(CGFloat)</code><br> val = 0 => receiver, val = 1 =>
     * shadowColor<br>
     ...
     * alpha, it's set to 1.0. Should be implemented by subclassers.<br> Original signature : <code>void
     * set()</code><br>
    ...
    /**
     * Set the fill or stroke colors individually. These should be implemented by subclassers.<br> Original signature :
     * <code>void setFill()</code><br>
    ...
    /**
     * Get the color space of the color. Should be implemented by subclassers.<br> Original signature : <code>NSString*
     * colorSpaceName()</code><br>
     ...
     * colorspaces override this method to do something better.<br> The version of this method which takes a device
     * description allows the color to specialize itself for the given device.  Device descriptions can be obtained from
     * windows, screens, and printers with the "deviceDescription" method.<br> If device is nil then the current device
     * (as obtained from the currently lockFocus'ed view's window or, if printing, the current printer) is used. The
     * method without the device: argument passes nil for the device.<br> If colorSpace is nil, then the most
     * appropriate color space is used.<br> Original signature : <code>NSColor* colorUsingColorSpaceName(NSString*)</code><br>
     ...
     * same as the one specified.  Will return nil if conversion is not possible.<br> Original signature :
     * <code>NSColor* colorUsingColorSpace(NSColorSpace*)</code><br>
     ...
     * is returned.<br> Original signature : <code>NSColor* blendedColorWithFraction(CGFloat, NSColor*)</code><br>
     ...
     * have explicit opacity components override this method to actually return a color with the specified alpha.<br>
     ...
     * usually looked up on each device by their name.<br> Original signature : <code>NSString*
     * catalogNameComponent()</code><br>
    ...
    /**
     * Return localized versions of the above.<br> Original signature : <code>NSString*
     * localizedCatalogNameComponent()</code><br>
    ...
    /**
     * Get the red, green, or blue components of NSCalibratedRGB or NSDeviceRGB colors.<br> Original signature :
     * <code>CGFloat redComponent()</code><br>
    ...
    /**
     * Get the components of NSCalibratedRGB or NSDeviceRGB colors as hue, saturation, or brightness.<br> Original
     * signature : <code>CGFloat hueComponent()</code><br>
    ...
    /**
     * Get the white component of NSCalibratedWhite or NSDeviceWhite colors.<br> Original signature : <code>CGFloat
     * whiteComponent()</code><br>
    ...
    /**
     * Get the CMYK components of NSDeviceCMYK colors.<br> Original signature : <code>CGFloat
     * cyanComponent()</code><br>
     ...
     * exceptions otherwise, like other existing colorspace-specific methods.<br> Original signature :
     * <code>NSColorSpace* colorSpace()</code><br>
