...
namespace Ch.Cyberduck.Ui.Controller
{
    public class PromptLoginController : PromptPasswordController, LoginCallback
    {
        ...
        object ConnectionCallback.select(Host bookmark, string title, string message, Set regions, Location.Name defaultRegion) => ConnectionCallback.__DefaultMethods.select(this, bookmark, title, message, regions, defaultRegion);

        object LocationCallback.select(Host bookmark, string title, string message, Set regions, Location.Name defaultRegion) => LocationCallback.__DefaultMethods.select(this, bookmark, title, message, regions, defaultRegion);
